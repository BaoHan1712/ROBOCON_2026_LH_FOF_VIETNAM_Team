...
void di_tren_buc_khong_thanh_2_ben_do(void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				else																robotRunAngle(900,20,-900,0.7); // di thang
				vTaskDelay(1);
				if(!wantExit()) break;
					}
			}
...
void chuan_bi_gap_phai_200_tren_do (void ) {
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			...
			/// gap lan 3
				...
				for(i=0;i<150;i++)
						{
					while(lazeTruocValue < 27 || (abs(bientrochansauValue - target_chan_sau) > 300))	
							{	
								vTaskDelay (1);
								if(!wantExit())	break;
							}
...
void chuan_bi_gap_phai_200_tren_2_do (void ) {
	if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			...
			for(i=0;i<1550;i++)
						{
							while(lazeSauValue > 6|| (abs(bientrochansauValue - target_chan_sau) > 300) )	
							{	
								if(!wantExit())	break;
								vTaskDelay (1);
							}
...
void Leo_bac_200_do_7(void)  {	
	...
	if (TinHieu_ChuanBi_GapThang == 0 && TinHieu_ChuanBi_GapTrai == 0 && TinHieu_ChuanBi_GapPhai == 0 && TinHieu_QuaTrai == 0) {
		...
		for(i=0;i<1550;i++)
				{
						while(CB_Ha_Sau == 0 || CB_vtri_leo == 0 || (abs(bientrochansauValue - target_chan_sau) > 30)	)	
