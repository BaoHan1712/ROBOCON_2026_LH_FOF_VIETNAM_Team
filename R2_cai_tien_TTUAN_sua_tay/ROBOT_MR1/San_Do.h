...
void Xuat_Phat_Lay_Vu_Khi_Do(int vu_khi, int goc_ve, int vitri) {					
				...
				for(i=0;i<250;i++)
				{
					...
					{	
						...
						Bam_thanh_laser_trai(20,0,0,vu_khi ,1,-100,15);
						vTaskDelay(1); 
						if(!wantExit())	break;
					}
				}
				...
				robotStop(2);
//				
				run_encoder(1080, 1800, 0, 35, 8, 500, 10);
				...
				robotStop(2);
				chinh_lai_vi_tri_VK_do(vitri, 500, 6, 50, 0);
				robotStop(2);
...
void nhat_hop_zone3_do (void) {
    ...
    bool thu_lai = false;
		...
		run_encoder(11000, 1800, 0, 65, 35, 2500, 50);
