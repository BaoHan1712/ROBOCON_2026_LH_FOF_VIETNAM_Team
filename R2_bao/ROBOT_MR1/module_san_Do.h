...
void qua_trai_len_bac_400_do(void) {
	...
	chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_3_lazer_phai_tay_41 - 10, 1000, 7, 45, 3);
	...
	if (TinHieu_ChuanBi_GapThang == 1 ) {
		if (da_lay_tay1 == 1 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
					chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_3_lazer_phai_tay_41, 1000, 5, 55, 3);
					}
		else if (da_lay_tay1 == 1 && da_lay_tay2 == 1 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
					chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_3_lazer_phai_tay_23, 1000, 5, 55, 3); 
					}
		robotStop(0);
		robotRunAngle(900,12,-900,0.5);
		for(i=0;i<1050;i++)	
...
void qua_trai_len_bac_200_cua_vao_do(void) {
	...
	if ( TinHieu_ChuanBi_GapThang == 1 ) {
			...
			chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_2_lazer_phai_tay_41 - 15, 1000, 6, 55, 6);
			}
			else if (chay_ngang_qua_o3_do == 1) {
			chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_3_lazer_phai_tay_41 - 10, 1000, 6, 55, 6);
				}
		}
...
void qua_phai_len_bac_400_do(void) {
	...
	chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_1_lazer_phai_tay_23 + 10, 1000, 7, 45, 3);
	...
	if (TinHieu_ChuanBi_GapThang == 1 ) {
			...
			if (da_lay_tay1 == 1 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
						chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_1_lazer_phai_tay_41, 1000, 5, 30, 1);
						}
			else if (da_lay_tay1 == 1 && da_lay_tay2 == 1 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
						chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_1_lazer_phai_tay_23, 1000, 5, 30, 1);
						}
	...
	robotStop(0);
		if ( TinHieu_ChuanBi_GapThang == 1 ) {
				...
				if (chay_ngang_qua_o1_do == 0) {
						...
						chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_1_lazer_phai_tay_41 - 10, 1000,6, 55, 6);
						}
				}
		robotStop(0);
		bai_db = 1;
...
void chuan_bi_gap_trai_200_duoi_ko_thanh_do (void ) {
			if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
					...
					if(CB_ROI_4  == 0 && CB_ROI_2 == 0)	robotRunAngle(550,14,-900,0.8);
...
void chuan_bi_gap_phai_200_duoi_ko_thanh_do(void ) {
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			...
			//// gap duoi lan 3
					...
					ha_sat_xuong();
					while( CB_Ha_Sau == 0 || (abs(bientrochansauValue - target_chan_sau) > 10)) {
					if(CB_ROI_3  == 0 && CB_ROI_1 == 0)	robotRunAngle(1350,15,-900,0.8);
					else																robotRunAngle(900,10,-900,0.8);
					vTaskDelay(1);
					if(!wantExit()) break;
						}
		...
		su_dung_chan(265);
			...
			if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				while( CB_Ha_Sau == 0 || (abs(bientrochansauValue - target_chan_sau) > 20)) 
					{	
					if(lazeTraiValue > vitri_tay41)			robotRunAngle(1550,15,-900,0.7);
					else																robotRunAngle(900,12,-900,0.7);
					vTaskDelay(1);
					if(!wantExit()) break; }
					Tay2_len;
...
void chuan_bi_gap_thang_do_2(void) {
			...
			if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
					...
					while( CB_Cap_Thanh_Sau == 0 ||  (abs(bientrochansauValue - target_chan_sau) > 20))	
					{	
					if(lazeTraiValue > vitri_tay41)			robotRunAngle(1450,12,-900,0.7);
					else																robotRunAngle(900,10,-900,0.7);
					vTaskDelay(1);
					if(!wantExit()) break;
								}
					...
					while( CB_Cap_Thanh_Sau == 0 ||  (abs(bientrochansauValue - target_chan_sau) > 20))	
					{	
					if(lazePhaiValue > vitri_tay23)			robotRunAngle(450,12,-900,0.7);
					else																robotRunAngle(900,10,-900,0.7);
					vTaskDelay(1);
					if(!wantExit()) break;
								}
...
void chuan_bi_gap_trai_200_tren_do_4 (void ) {
	...
	if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				for(i=0;i<1550;i++) {
						while( CB_Cap_Thanh_Sau == 0 ||  (abs(bientrochansauValue - target_chan_sau) > 200))	
						{	
...
void chuan_bi_gap_thang_do_7(void) {
	...
	if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				if(CB_ROI_1  == 0 && CB_ROI_3 == 0)	robotRunAngle(1550,12,-900,0.7);
				...
				while (CB_ROI_3  == 0 )	 {
					...
					while(CB_Ha_Sau == 0 || (abs(bientrochansauValue - target_chan_sau) > 15)) 
					{	
						if(lazePhaiValue > vitri_tay23)			robotRunAngle(350,12,-900,0.7);
						else																robotRunAngle(900,8,-900,0.7);
						vTaskDelay(1);
						if(!wantExit()) break;
						Tay2_len;
...
void qua_trai_len_bac_200_5_do (void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				MD_qua_trai_phai_len_bac_200(-1800, -900, -450, time_41,-900, 0, -1800);
			}
			//// gap 2 lan r
		else if (da_lay_tay1 == 1 && da_lay_tay2 == 1 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {		
				MD_qua_trai_phai_len_bac_200(-1800, -900, -450, time_41,-900, 0, -1800);
			...
			//// gap 3 lan r
				...
				MD_qua_trai_phai_len_bac_200(-1800, -900, -1350, time_23,-900, 0, -1800);
			}
		else if (da_lay_tay1 == 1 && da_lay_tay2 == 1 && da_lay_tay3 == 1 && da_lay_tay4 == 1) {		
				MD_qua_trai_phai_len_bac_200(-1800, -900, -1350, time_23,-900, 0, -1800);
			}
...
void qua_trai_xuong_bac_200_9_do (void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				MD_qua_trai_phai_xuong_bac_200(-1800, -900, -450, time_41,-900, 0, -1800);
			}
			//// gap 2 lan r
		else if (da_lay_tay1 == 1 && da_lay_tay2 == 1 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {		
				MD_qua_trai_phai_xuong_bac_200(-1800, -900, -450, time_41,-900, 0, -1800);
		...
		//// gap 3 lan r
				...
				MD_qua_trai_phai_xuong_bac_200(-1800, -900, -1350, time_23,-900, 0, -1800);
			}
		else if (da_lay_tay1 == 1 && da_lay_tay2 == 1 && da_lay_tay3 == 1 && da_lay_tay4 == 1) {		
				MD_qua_trai_phai_xuong_bac_200(-1800, -900, -1350, time_23,-900, 0, -1800);
			}
...
void qua_phai_xuong_bac_200_4_do (void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				MD_qua_trai_phai_xuong_bac_200(0,-900, -350, time_41,-900, 1800, 0);
			}
			//// gap 2 lan r
		else if (da_lay_tay1 == 1 && da_lay_tay2 == 1 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {		
				MD_qua_trai_phai_xuong_bac_200(0,-900, -350, time_41,-900, 1800, 0);
		...
		//// gap 3 lan r
				...
				MD_qua_trai_phai_xuong_bac_200(0,-900, -1350, time_23,-900, 1800, 0);
			}
		else if (da_lay_tay1 == 1 && da_lay_tay2 == 1 && da_lay_tay3 == 1 && da_lay_tay4 == 1) {		
				MD_qua_trai_phai_xuong_bac_200(0,-900, -1350, time_23,-900, 1800, 0);
			}
...
void qua_phai_xuong_bac_200_5_do (void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				MD_qua_trai_phai_xuong_bac_200(0,-900, -450, time_41,-900, 1800, 0);
			}
			//// gap 2 lan r
		else if (da_lay_tay1 == 1 && da_lay_tay2 == 1 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {		
				MD_qua_trai_phai_xuong_bac_200(0,-900, -450, time_41,-900, 1800, 0);
...
void qua_phai_len_bac_200_8_do (void) {
		...
		/// ***************************
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				MD_qua_trai_phai_len_bac_200(0,-900, -750, time_41,-900, 1800, 0);
			}
		else if (da_lay_tay1 == 1 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				MD_qua_trai_phai_len_bac_200(0,-900, -450, time_41,-900, 1800, 0);
			}
			//// gap 2 lan r
		else if (da_lay_tay1 == 1 && da_lay_tay2 == 1 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {		
				MD_qua_trai_phai_len_bac_200(0,-900, -450, time_41,-900, 1800, 0);
		...
		//// gap 3 lan r
				...
				MD_qua_trai_phai_len_bac_200(0,-900, -1350, time_23,-900, 1800, 0);
			}
		else if (da_lay_tay1 == 1 && da_lay_tay2 == 1 && da_lay_tay3 == 1 && da_lay_tay4 == 1) {		
				MD_qua_trai_phai_len_bac_200(0,-900, -1350, time_23,-900, 1800, 0);
			}
