...
void chuan_bi_gap_phai_200_tren_3 (void ) {
	if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			...
			for(i=0;i<1550;i++)
						{
							while(lazeSauValue > 136 || (abs(bientrochansauValue - target_chan_sau) > 200) )	
							{	
								if(!wantExit())	break;
								vTaskDelay (1);
							}
...
void chuan_bi_gap_phai_200_tren_4 (void ) {
	if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			...
			for(i=0;i<1550;i++)
						{
							while(lazeSauValue > 136 || (abs(bientrochansauValue - target_chan_sau) > 300) )	
							{	
								if(!wantExit())	break;
								vTaskDelay (1);
							}
