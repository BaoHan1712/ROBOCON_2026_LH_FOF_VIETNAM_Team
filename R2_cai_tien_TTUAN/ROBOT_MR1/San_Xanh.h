...
{				
				...
				for(i=0;i<250;i++)
				{
					...
					{	
						...
						Bam_thanh_laser_phai(53,0,0,vu_khi,2,150,30);
				...
				for(i=0;i<100;i++)
				{
					while(HT_1 == 0 && HT_2 == 0)	
					{				
						if(lazeTruocValue < 145)	Tay_kep_xuong;
...
void tudonghoantoan(void) {
		...
		Xuat_Phat_Lay_Vu_Khi_Xanh(163, -1700, 200);
    mo_vk_san_xanh();
