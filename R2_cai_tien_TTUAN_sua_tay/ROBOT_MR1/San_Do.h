...
void Xuat_Phat_Lay_Vu_Khi_Do(int vu_khi, int goc_ve, int vitri) {					
				...
				for(i=0;i<250;i++)
				{
					...
					{	
						Bam_thanh_laser_trai(47,-170,0,vu_khi  ,2,-100,10);
						vTaskDelay(1); 
						if(!wantExit())	break;
					}
				}
				...
				for(i=0;i<250;i++)
				{
					...
					{	
						...
						Bam_thanh_laser_trai(34,-80,0,vu_khi ,2,-100,10);
						vTaskDelay(1); 
						if(!wantExit())	break;
					}
				}
				...
				for(i=0;i<250;i++)
				{
					...
					{	
						...
						Bam_thanh_laser_trai(28,-20,0,vu_khi ,1,-100,10);
						vTaskDelay(1); 
						if(!wantExit())	break;
					}
				}
				...
				for(i=0;i<250;i++)
				{
					...
					{	
						...
						Bam_thanh_laser_trai(22,-20,0,vu_khi ,1, -100, 10);
						vTaskDelay(1); 
						if(!wantExit())	break;
					}
				}
				...
				for(i=0;i<100;i++)
				{
					while(HT_1 == 0 && HT_2 == 0)	
					{			
						if(lazeTruocValue < 141)	Tay_kep_xuong;
				...
				robotStop(2);
//				
				run_encoder(1150, 1800, 0, 38, 6, 500, 10);
