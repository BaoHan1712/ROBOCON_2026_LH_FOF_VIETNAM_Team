...
int	Min_tay_gat2 = 95, Max_tay_gat2 = 768, target_tay_gat2;
...
{	
	...
	robotRunAngle(Angle,9,Robot_Angle,-0.2);
	...
	robotRunAngle(Angle,15,Robot_Angle,-0.2);
	...
	//robotRunAngle(Angle,8,Robot_Angle,-0.2);
	for(i=0;i<1000;i++)	
	{	
