...
//				
				...
				if(SQUARE && L2 && !R2) 														Lay_ben_phai_bac_200_duoi();
				if(X && L2 && !R2) 																	su_dung_chan(400);
////				if(O && L2 && !R2 ) 															phun_tay();
...
//			if(O && L2 && !R2)															Xuat_Phat_Lay_Vu_Khi_Xanh(169,-1650,233) ;
					...
					if(TRIANGLE && L2 && !R2) 												 	 		su_dung_chan_thuong(650);
					if(SQUARE && L2 && !R2) 																su_dung_chan_thuong(350);
...
//					if(SQUARE && L2 && !R2) 															Leo_bac_400_co_thanh();
