...
//=============================ADC DMI======================================//
#define cam_bien_laze_phai			       			 _ADC1_Value[0]//A2
#define cam_bien_laze_trai			       			 _ADC1_Value[1]//A3
...
#define Quang_tro								 	 	 				 _ADC1_Value[8]//A7

#define bien_tro_gat1												 _ADC1_Value[5]//pinA8
#define bien_tro_gat2												 _ADC1_Value[9]//pinA9
...
#define  CB_kep_1_1											GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_14)//OK
#define  CB_kep_1_2											GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_10)//OK
#define  CB_kep_2_1											GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_13)//OK
#define  CB_kep_2_2											GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_12)//OK
#define  CB_kep_3_1											GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_15)//OK
#define  CB_kep_3_2											GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_14)//OK
#define  CB_kep_4_1											GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_10)//OK
#define  CB_kep_4_2											GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_11)//OK
#define  CB_vtri_leo										GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_6)//OK
...
int vi_tri_tay_12 = 696;

int vitri_tay41_laser_trai_GapQua = 161;
int vitri_tay23_laser_trai_GapQua = 226;
int vitri_tay23_phai_laser_GapQua = 161;
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 9:
										...
										break;
									case 10:
										HMI_DMI("count_data_uart4 ",count_data_uart4,10);  
										break;
									case 11:
											HMI_DMI("IMU:", -IMU,11);	
										break;
									case 12:
											HMI_DMI("Lazer phai",lazePhaiValue,12);  
										break;
									case 13:
											HMI_DMI("Lazer trai ",lazeTraiValue,13);
										break;
									case 14:
										HMI_DMI("Lazer sau",lazeSauValue,14); 
										break;		
									case 15:
										HMI_DMI("Lazer truoc ",lazeTruocValue,15);  
										break;	
								  case 16:
                              ...
                              snprintf(_ghep_bit, sizeof(_ghep_bit), "%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d",
									...
									case 18:
										...
										break;	
									case 19:
										HMI_DMI("Lazer truoc ",lazeTruocValue,19);  
										break;	
									case 20:
