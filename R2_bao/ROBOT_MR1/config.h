...
int vi_tri_tay_4_trai_tren = 405;
...
int vi_tri_cua_rung_do_1_lazer_phai_tay_41 = 310;
int vi_tri_cua_rung_do_1_lazer_phai_tay_23 = 265;

int vi_tri_cua_rung_do_2_lazer_trai_tay_41 = 460;
int vi_tri_cua_rung_do_2_lazer_phai_tay_23 = 410;

int vi_tri_cua_rung_do_3_lazer_trai_tay_41 = 308;
int vi_tri_cua_rung_do_3_lazer_trai_tay_23 = 371;
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 13:
										...
										break;
									case 14:
										HMI_DMI("ENCODER_RR ",ENCODER_RR(),14);
										break;		
									case 15:
										HMI_DMI("ENCODER_RL ",ENCODER_RL(),15);///
										break;	
								  case 16:
                              ...
                              snprintf(_ghep_bit, sizeof(_ghep_bit), "%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d",
                                    ...
                                    GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_7)
										...
										break;	
									case 18:
										HMI_DMI("Quang_tro : ",quangTroValue,18); 
//										HMI_DMI("TinHieu_GapThang: ",TinHieu_ChuanBi_GapThang,18);  
										break;	
									case 19:
										HMI_DMI("TinHieu_ChuanBi_GapPhai ",TinHieu_ChuanBi_GapPhai,19);  
										break;	
									case 20:
