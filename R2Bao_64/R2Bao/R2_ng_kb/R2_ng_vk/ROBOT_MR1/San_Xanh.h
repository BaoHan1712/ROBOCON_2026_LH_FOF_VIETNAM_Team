...
void quyet_dinh_dat_hop_tang3(void) {
		if (so_qua_tren_tay == 1 || so_qua_tren_tay == 2  ) {
				be_len_dat_xanh_1_qua_tren_3();
			}
		else if (so_qua_tren_tay == 3 || so_qua_tren_tay == 4) {
				be_len_dat_xanh();
		}
...
void chon_o_nhat_hop_xanh(void) {
		...
		if (nhat_dat_hop == 1) {
				chinh_lai_vi_tri_laser_phai_zone3_do(207, 200);
			}
...
//			for(i=0;i<500;i++)	{ 
//				while (abs(bientrodaytay2Value - (vitri_tay2home - 115)) > 5) 
//				{
//						speed_tay_gat2 = 250;
//						target_tay_gat2 = vitri_tay2home ;
//						
