//0**********************************SAN DO*************************************
void Xuat_Phat_Lay_Gay_Do(int kc1) 
{				
	int i;
...
//	
	...
	{	
			...
			{
				Bam_thanh_laser_phai(50,1800,-5,kc1,2,-200,30);
				vTaskDelay(1); 
				if(wantExit())	break;
			}
	}
	...
	{	
			...
			{
				Bam_thanh_laser_phai(20,1800,-5,kc1,1,-50,30);
				vTaskDelay(1); 
				if(wantExit())	break;
			}
	}
	...
	RESET_ENCODER_CHAY();
	robotRunAngle(1800,12,-5,0.2);
	while(abs(ENCODER_CHAY()) < 5000)	{vTaskDelay(5); if(wantExit())	break;}
	...
	{	
			while(lazeSauValue > 130)	
			{
				...
				Bam_thanh_laser_trai(25,1800,-5,140,2,-100,5);
				vTaskDelay(1); 
				if(wantExit())	break;
			}
...
//				speed_nang = 250;
//				target_nang = 960;
//				Bam_thanh_laser_trai(30,0,0,5,3,120,20);
//				vTaskDelay(1); 
//				if(wantExit())	break;
//			}
//	}
