...
//				
	...
	if (TinHieu_ChuanBi_GapThang == 1) {
			chinh_lai_vi_tri_laser_phai_custom(vi_tri_cua_rung_xanh_1_lazer_phai_tay_41 + 5 , 1000, 5 , 65 );
	}
...
//				
	...
	if (TinHieu_ChuanBi_GapThang == 0) {
			...
			chinh_lai_vi_tri_laser_phai_custom(vi_tri_cua_rung_xanh_2_lazer_phai_tay_41  , 1000, 5, 65);
	}
	robotStop(0); 
		if (block_pha == 2) {
	SEND_UART (4,1);
...
//				
	...
	robotStop(0);
	if (TinHieu_ChuanBi_GapThang == 1) {
			chinh_lai_vi_tri_laser_phai_custom(vi_tri_cua_rung_xanh_3_lazer_phai_tay_41  , 1000, 5, 65);
	}
	else if (TinHieu_ChuanBi_GapThang == 0) {
...
void Vao_rung_mai_1_xanh(int vitri)
{
	...
	target_chan_sau = Min_chan_sau + 250;
		...
		for(i=0;i<250;i++)
		{
			...
			{	
			Bam_thanh_laser_phai_cua_vao(45,-900,900,vitri,5,150,30);
				vTaskDelay (1);
				if(!wantExit())	break;
			}
				}
			for(i=0;i<250;i++)	
		{
			while(abs(bientrochansauValue - target_chan_sau) > 20)
									{	
			Bam_thanh_laser_phai_cua_vao(35,-900,900,vitri,2,150,30);
			if(!wantExit())	break;
						}
		}
			...
			for(i=0;i<250;i++)
					{
						...
						{	
							Bam_thanh_laser_phai_cua_vao(20,-900,900,vitri - 15,2,150,30);
							vTaskDelay (1);
							if(!wantExit())	break;
						}
				}
				...
				for(i=0;i<250;i++)
				{
					...
					{	
						Bam_thanh_laser_phai_cua_vao(10,-900,900,vitri - 15,2,150,30);
						if(!wantExit())	break;
					}
				}
//				chinh_lai_vi_tri_laser_phai(vitri - 15, 1000);
					...
					for(i=0;i<250;i++)
					{
						while(lazeSauValue > 15)	
						{	
							Bam_thanh_laser_phai_cua_vao(20,-900,900,vitri ,2,150,30);
							vTaskDelay (1);
							if(!wantExit())	break;
						}
				}
			...
			for(i=0;i<250;i++)
				{
					while(lazeSauValue > 30)	
					{	
						Bam_thanh_laser_phai(20,-900,900,vitri - 15,2,-350,30);
						vTaskDelay (1);
						if(!wantExit())	break;
					}
			}	
			for(i=0;i<1550;i++)
						{
							...
							{	
								Bam_thanh_laser_phai(10,-900,900,vitri - 10,2,-350,30);
								if(!wantExit())	break;
								vTaskDelay (1);
							}
						}
				...
				for(i=0;i<1550;i++)
						{
							while( CB_Ha_Sau == 1 || CB_Cap_Thanh_Sau == 0)	
							{	
								Bam_thanh_laser_phai(10,-900,900,vitri,2,-350,30);
								if(!wantExit())	break;
								vTaskDelay (1);
							}
						}
	...
	for(i=0;i<250;i++)
					{
						while(lazeSauValue > 115)	
						{	
							Bam_thanh_laser_trai(45,-900,900,vitri + 15,3,150,30);
							vTaskDelay (1);
							if(!wantExit())	break;
						}
				}
		...
		for(i=0;i<250;i++)
					{
						while(lazeSauValue > 30)	
						{	
							Bam_thanh_laser_trai(28,-900,900,vitri + 15,2,150,30);
							vTaskDelay (1);
							if(!wantExit())	break;
						}
				}
				...
				for(i=0;i<1550;i++)
							{
									while( CB_vtri_leo == 1 ||CB_Ha_Sau == 1 || CB_Cap_Thanh_Sau == 0)	
								{	
									Bam_thanh_laser_trai(10,-900,900,vitri + 15,2,150,30);
									vTaskDelay (1);
									if(!wantExit())	break;
...
void chuan_bi_gap_trai_200_duoi_5 (void ) {
	...
	if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				// chuan bi xoay truoc sang trai
					...
					if(CB_ROI_2  == 0 && CB_ROI_4 == 0)	robotRunAngle(-1250,14,900,0.7);
					else																robotRunAngle(-900,10,900,0.7);
					vTaskDelay(1);
					if(!wantExit()) break;
								}
...
void chuan_bi_gap_phai_200_duoi_ko_thanh (void ) {
	...
	if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			...
			//// gap duoi lan 3
					...
					ha_sat_xuong();
					while( CB_Ha_Sau == 0 || (abs(bientrochansauValue - target_chan_sau) > 20)) {
					if(CB_ROI_3  == 0 && CB_ROI_1 == 0)	robotRunAngle(-650,14,900,0.7);
					else																robotRunAngle(-900,10,900,0.7);
					vTaskDelay(1);
					if(!wantExit()) break;
						}
...
void DatKFSxanh(int vitri)
{
	...
	chinh_lai_vi_tri_laser_phai_custom(188, 1000, 5, 55);
	

		robotRunAngle(-900,55,900,0.8);
		for(i=0;i<550;i++)	
	{	
...
//	**************** che do cay diem  ******************
	if (mode_cay_diem == 1 ) {
			for(i=0;i<550;i++)	
			{	
					while(lazeTraiValue > 240)	
					{	
						Bam_laser_sau(40,0,900, vitri, 3, -120, 10);
						vTaskDelay(5); 
						if(!wantExit())	break;
					}
			}
			...
			{	
					...
					{	
						Bam_laser_sau(12,0,900, vitri, 1, -100, 10);
						vTaskDelay(5); 
						if(!wantExit())	break;
					}
			}	
...
//	// ************** che do thang nhanh ***********
	if (mode_cay_diem == 2 ) {
			...
			{	
					...
					{	
						Bam_laser_sau(40,0,900, vitri + 68, 3, -150, 10);
						vTaskDelay(5); 
						if(!wantExit())	break;
					}
			}
			...
			{	
					while(lazeTraiValue > 187)	
					{	
						Bam_laser_sau(12,0,900, vitri + 68, 1, -120, 10);
						su_dung_chan_cham(505);
						vTaskDelay(1); 
						if(!wantExit())	break;
					}
			}	
...
void tudonghoantoan(void) {
		Xuat_Phat_Lay_Vu_Khi_Xanh(168, -1670, 192);
    mo_vk_san_xanh();
    ...
    if (da_lay_vk == 2) {    
		...
		if (hoan_thanh_chay_rung == 2 && mode_cay_diem == 1)  {
				...
				robotStop(0);
				chinh_lai_vi_tri_laser_sau(vi_tri_dat_hop_2_tay41_xanh, 100);
				robotStop(0);
        chinh_lai_vi_tri_laser_trai(180, 1000);
				...
				vTaskDelay(7000);
				robotStop(0);
				su_dung_chan_thuong(700);
				chinh_lai_vi_tri_laser_sau(35, 100);
				hoan_thanh_chay_rung = 3 ;}
...
//				}
//				robotStop(0);
//				chinh_lai_vi_tri_laser_sau(106, 100);
//				robotStop(0);
//        chinh_lai_vi_tri_laser_trai(180, 1000);
//				robotStop(0);
//				dat_hop_vao_o_tang2();	
...
void chon_o_nhat_hop_xanh(void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0) {
				dat_hop4_2(495, 345,5, 4);
				}
		else if (da_lay_tay1 == 1 && da_lay_tay2 == 0) {
				dat_hop1_3(495, 550,5, 1);
				}
		}
...
void tu_dong_dat_tang2_xanh(void) {
		...
		if (tay_1_co_qua || tay_4_co_qua) {
        if (robot_position == 1) {
            chinh_lai_vi_tri_laser_sau(vi_tri_dat_hop_1_tay41_xanh, 100);
            robotStop(0);
            chinh_lai_vi_tri_laser_trai(180, 1000);
        } 
            ...
            chinh_lai_vi_tri_laser_sau(vi_tri_dat_hop_3_tay41_xanh, 100);
            robotStop(0);
            chinh_lai_vi_tri_laser_trai(180, 1000);
        }
    } 
        ...
        if (robot_position == 1) {
            chinh_lai_vi_tri_laser_sau(vi_tri_dat_hop_1_tay23_xanh, 100);
            robotStop(0);
            chinh_lai_vi_tri_laser_trai(193, 1000); /// trg hop tay 3 vi trí 1
        } 
        else if (robot_position == 2) {
            chinh_lai_vi_tri_laser_sau(vi_tri_dat_hop_2_tay23_xanh, 100);
            robotStop(0);
            chinh_lai_vi_tri_laser_trai(180, 1000);
        } 
        else if (robot_position == 3) {
            chinh_lai_vi_tri_laser_sau(vi_tri_dat_hop_3_tay23_xanh, 100);
            robotStop(0);
            chinh_lai_vi_tri_laser_trai(180, 1000);
        }
    }
