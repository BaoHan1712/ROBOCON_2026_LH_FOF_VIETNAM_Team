...
int	Min_tay_gat1 = 98, Max_tay_gat1 = 775, target_tay_gat1;
int	Min_tay_gat2 = 95, Max_tay_gat2 = 770, target_tay_gat2;
...
{	
	...
	target_chan_truoc = Max_chan_truoc - 8, target_chan_sau = Max_chan_sau - 8;
  ...
  Nang_cuc_nhanh();
	target_chan_truoc = 267, target_chan_sau = 263;
...
{	
	...
	robotRunAngle(Angle,10,Robot_Angle,0.2);
...
{		
		...
		Tay1_len;
		speed_tay_gat1 = 230;
		target_tay_gat1 = Max_tay_gat1 - 47;
		for(i=0;i<50;i++)	{ 
		...
		vTaskDelay (1000);
		// chi tracking hop  khi gap thang
		...
		for(i=0;i<50;i++)	{ // xuong khong duoc thi len tracking lai
...
{	
		...
		speed_tay_gat1 = 200;
		target_tay_gat1 = (Min_tay_gat1+ 2);
		for(i=0;i<50;i++)	{ 
						while(abs(bientrodaytay1Value - target_tay_gat1)> 10 )	{vTaskDelay(1); if(!wantExit())	break;}
				}
		vTaskDelay (3000);
...
{		
		...
		Kep_phai_1_ra;
		speed_tay_gat1 = 150;
		target_tay_gat1 = (Max_tay_gat1 - 10);
			...
			for(i=0;i<150;i++)		
	{
		...
		speed_tay_gat1 = 150;
		target_tay_gat1 = (Max_tay_gat1 - 3);
		for(i=0;i<50;i++)	{ 
					while(abs(bientrodaytay1Value - target_tay_gat1)> 5 )	{vTaskDelay(1); if(!wantExit())	break;}
				}
		vTaskDelay (2000);
...
{	
		...
		for(i=0;i<550;i++)	{ 
					while(abs(bientrodaytay2Value - target_tay_gat2) > 7 )	
					{vTaskDelay(1); if(!wantExit())	break;}
				}
		vTaskDelay(1000);
			...
			for(i=0;i<150;i++)		
	{
		...
		speed_tay_gat2 = 250;
		target_tay_gat2 = (Max_tay_gat2 - 8	 );
		for(i=0;i<50;i++)	{ 
						while(abs(bientrodaytay2Value - target_tay_gat2)> 10 )	{vTaskDelay(1); if(!wantExit())	break;}
				}
		vTaskDelay (2000);
...
{	
		speed_tay_xoay = 100;
		target_xoay_tay = vi_tri_tay_43 + 8;
		for(i=0;i<150;i++)	{ 
				while((abs(bientroxoaytayValue - target_xoay_tay) > 10) )	{vTaskDelay(1); if(!wantExit())	break;}
			}
		Kep_phai_3_ra;
		Tay1_len;
		speed_tay_gat1 = 200;
		target_tay_gat1 = (Min_tay_gat1+ 58);
		for(i=0;i<50;i++)	{ 
						while(abs(bientrodaytay1Value - target_tay_gat1)> 10 )	{vTaskDelay(1); if(!wantExit())	break;}
				}
		...
		for(i=0;i<500;i++)
				{
					...
					{	
						if	(CB_kep_3_2 == 0 ) 			robotRun(-910,4);	
						else if 	(CB_kep_3_1 == 0) robotRun(910,4);
		...
		for(i=0;i<500;i++)
				{
					...
					{	
						if	(CB_kep_4_2 == 0 ) 					robotRun(-900,4);	
						else if 	(CB_kep_4_1 == 0  ) robotRun(900,4);
						vTaskDelay (1);
						if(!wantExit())	break;
					}
				}	
		...
		for(i=0;i<500;i++)
				{
					...
					{	
						if	(CB_kep_1_2 == 0 ) 			robotRun(-910,4);	
						else if 	(CB_kep_1_1 == 0 ) robotRun(910,4);
		...
		for(i=0;i<500;i++)
				{
					...
					{	
						if	(CB_kep_2_2 == 0 ) 			robotRun(-910,4);
						else if 	(CB_kep_2_1 == 0 ) robotRun(910,4);
