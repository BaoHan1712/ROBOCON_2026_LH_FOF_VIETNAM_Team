...
void qua_trai_len_bac_400_do(void) {
	...
	chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_3_lazer_phai_tay_41 - 10, 1000, 5, 45, 3);
	...
	if (TinHieu_ChuanBi_GapThang == 1 ) {
		if (da_lay_tay1 == 1 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
					chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_3_lazer_phai_tay_41, 1000, 5, 50, 3);
					}
		else if (da_lay_tay1 == 1 && da_lay_tay2 == 1 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
					chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_3_lazer_phai_tay_23, 1000, 5, 50, 3); 
					}
		robotStop(0);
		robotRunAngle(900,12,-900,0.5);
		for(i=0;i<1050;i++)	
...
void qua_trai_len_bac_200_cua_vao_do(void) {
	...
	if ( TinHieu_ChuanBi_GapThang == 1 ) {
				...
				chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_2_lazer_phai_tay_41 , 1000, 5, 30, 3);
				su_dung_chan(575);
			...
			if (chay_ngang_qua_o3_do == 0) {
					...
					while(abs(ENCODER_FR()) + abs(ENCODER_FL()) < 10000)	{
								vTaskDelay (5); if(!wantExit())	break;}
					robotStop(0);
					chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_2_lazer_phai_tay_41 - 13, 1000, 5, 30, 3);
			}
					...
					while(abs(ENCODER_FR()) + abs(ENCODER_FL()) < 18000)	{
							vTaskDelay (5); if(!wantExit())	break;}
					robotStop(0);
					chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_3_lazer_phai_tay_41 - 13, 1000, 5, 30, 3);
				}
		}
...
void qua_phai_len_bac_400_do(void) {
	...
	chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_1_lazer_phai_tay_23 + 10, 1000, 5, 45, 3);
	...
	if (TinHieu_ChuanBi_GapThang == 1 ) {
			...
			if (da_lay_tay1 == 1 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
						chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_1_lazer_phai_tay_41, 1000, 5, 40, 1);
						}
			else if (da_lay_tay1 == 1 && da_lay_tay2 == 1 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
						chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_1_lazer_phai_tay_23, 1000, 5, 40, 1);
						}
	...
	vTaskDelay(2000);
		if ( TinHieu_ChuanBi_GapThang == 1 ) {
				...
				if (chay_ngang_qua_o1_do == 0) {
						...
						chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_2_lazer_phai_tay_41 - 10, 1000, 5, 30, 3);
			}
						...
						chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_1_lazer_phai_tay_41 - 10, 1000,5 , 30, 3);
						}
				}
		robotStop(0);
		bai_db = 1;
...
void di_tren_buc_khong_thanh_2_ben_do(void) {
		...
		// quay mam sang tay 2
				...
				while( CB_Ha_Sau == 0) {
				if(CB_ROI_2  == 0 && CB_ROI_4 == 0)	robotRunAngle(350,18,-900,0.7); //di xeo qua trai
				else																robotRunAngle(900,20,-900,0.7), Tay2_len;; //di thang
				vTaskDelay(1);
				if(!wantExit()) break;
							}
		...
		// quay mam sang tay 3
				...
				while(CB_Ha_Sau == 0) {
				if(CB_ROI_2  == 0 && CB_ROI_4 == 0)	robotRunAngle(350,18,-900,0.7);
...
void chuan_bi_gap_trai_200_duoi_ko_thanh_do (void ) {
			if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
					...
					if(CB_ROI_4  == 0 && CB_ROI_2 == 0)	robotRunAngle(550,16,-900,0.8);
					else																robotRunAngle(900,14,-900,0.8);
					vTaskDelay(1);
					if(!wantExit()) break;
						}
					Tay2_len;
					// chay toi roi thi di ngang qua phai
					robotRunAngle(-200,8,-900,0.7);
					while (CB_ROI_4  == 0 )	 {
						vTaskDelay(1);
						if(!wantExit()) break;
						}
...
void chuan_bi_gap_phai_200_duoi_ko_thanh_do(void ) {
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			...
			//// gap duoi lan 3
					...
					ha_sat_xuong();
					while( CB_Ha_Sau == 0 || (abs(bientrochansauValue - target_chan_sau) > 50)) {
					if(CB_ROI_3  == 0 && CB_ROI_1 == 0)	robotRunAngle(1350,16,-900,0.8);
					else																robotRunAngle(900,13,-900,0.8);
					vTaskDelay(1);
					if(!wantExit()) break;
						}
					Tay2_len;
...
void chuan_bi_gap_thang_do_3(void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				if(CB_ROI_3  == 0 && CB_ROI_1 == 0)	robotRunAngle(1250,18,-900,0.7);
		...
		// quay mam sang tay 2
				...
				while(CB_Cap_Thanh_Sau == 0 || (abs(bientrochansauValue - target_chan_sau) > 40))	 {
				if(CB_ROI_4  == 0 && CB_ROI_2 == 0)	robotRunAngle(650,18,-900,0.7);
				else																robotRunAngle(900,16,-900,0.7), Tay2_len;
				vTaskDelay(1);
				if(!wantExit()) break;
					}
...
void chuan_bi_gap_thang_do_2(void) {
			...
			if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
					...
					while( CB_Cap_Thanh_Sau == 0 ||  (abs(bientrochansauValue - target_chan_sau) > 40))	
					{	
					if(lazePhaiValue > vitri_tay23)			robotRunAngle(450,18,-900,0.7);
					else																robotRunAngle(900,15,-900,0.7), Tay2_len;
					vTaskDelay(1);
					if(!wantExit()) break;
								}
...
void chuan_bi_gap_phai_200_tren_2_do (void ) {
	if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			...
			for(i=0;i<1550;i++)
						{
							while(lazeSauValue > 130|| (abs(bientrochansauValue - target_chan_sau) > 300) )	
							{	
								if(!wantExit())	break;
								vTaskDelay (1);
							}
...
void chuan_bi_gap_thang_do_4(void) {
	int vitri_tay23 = vitri_tay23_phai_laser_GapQua + 8;
		kiem_tra_huong_quay_tay_gap_phia_truoc();
		su_dung_chan(565);
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			for(i=0;i<1550;i++) {
			...
			for(i=0;i<150;i++) {
						while( CB_Cap_Thanh_Sau == 0 ||(abs(bientrochansauValue - target_chan_sau) > 100))	
						{	
						if(lazePhaiValue > vitri_tay23)			robotRunAngle(350,18,-900,0.7);
						else																robotRunAngle(900,15,-900,0.7), Tay2_len;
						vTaskDelay(1);
						if(!wantExit()) break;
									}
	...
	if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				while (CB_ROI_3  == 0 )	 {
					...
					{	
						...
						while(CB_Ha_Sau == 0 || (abs(bientrochansauValue - target_chan_sau) > 25)) 
					{	
						if(lazePhaiValue > (vitri_tay23 + 2))			robotRunAngle(350,18,-900,0.7);
						else																robotRunAngle(900,20,-900,0.7), Tay1_len;
						vTaskDelay(1);
						if(!wantExit()) break;
									}
