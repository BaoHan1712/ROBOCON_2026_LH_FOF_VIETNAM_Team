...
//       ========================================= */
    ...
    /* =========================================
       ...
       ========================================= */
    action_table[1][4][1] = Leo_bac_400_ko_thanh_do;  // chua test
    action_table[1][4][2] = Leo_bac_200_bam_thanh_phai_do; // chua test
		action_table[1][4][3] = Leo_bac_400_co_thanh_do; // chua xong
		action_table[1][4][4] = Xuong_bac_200_do_4;	 // chua test		
    action_table[1][4][5] = Leo_bac_200_do_5;		// chua test
    action_table[1][4][6] = Leo_bac_200_ko_thanh_do;// chua xong
    action_table[1][4][7] = Leo_bac_200_do_7;  // chua tét
    action_table[1][4][8] = Leo_bac_200_ko_thanh_do; // chua xong
    action_table[1][4][9]  = Xuong_bac_200_do_9; 		// chua xong
    action_table[1][4][10] = xuong_bac_200_do_10; // chua xong
    action_table[1][4][11] = xuong_bac_200_11_do;
		action_table[1][4][12] = xuong_bac_200_do_12; // chua xong
