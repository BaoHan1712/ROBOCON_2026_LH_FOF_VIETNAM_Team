...
void qua_trai_len_bac_200_cua_vao_do(void) {
	...
	if ( TinHieu_ChuanBi_GapThang == 1 ) {
				run_encoder(12000, 0, -900, 45, 5, 5500, 100);
...
void qua_phai_len_bac_400_do(void) {
	...
	chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_1_lazer_phai_tay_41 , 1000, 12, 45, 3);
...
void qua_phai_len_bac_200_cua_vao_do(void) {
	...
	robotStop(0);
		if ( TinHieu_ChuanBi_GapThang == 1 ) {
				...
				run_encoder(10000, 1800, -900, 45, 5, 5500, 50);
				robotStop(0);
				...
				if (chay_ngang_qua_o1_do == 0) {
						...
						run_encoder(20700, 1780, -900, 45, 12, 5000, 50);
...
void di_tren_buc_khong_thanh_2_ben_do(void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				else																robotRunAngle(900,16,-900,0.7), Tay2_len;; // di thang
				vTaskDelay(1);
				if(!wantExit()) break;
					}
				...
				else																robotRunAngle(900,16,-900,0.7), Tay1_len;;  // di thang 
				vTaskDelay(1);
				if(!wantExit()) break;
					}
				robotRunAngle(1800,15,-900,0.8);
...
void chuan_bi_gap_thang_do_3(void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				else																robotRunAngle(900,18,-900,0.7);
				vTaskDelay(1);
				if(!wantExit()) break;
					}
				
				while(CB_Cap_Thanh_Sau == 0 )	 {
				if(CB_ROI_3  == 0 && CB_ROI_1 == 0)	robotRunAngle(1250,14,-900,0.7);
		...
		// quay mam sang tay 2
				...
				if(CB_ROI_4  == 0 && CB_ROI_2 == 0)	robotRunAngle(300,22,-900,0.7), Tay2_len;
				else																robotRunAngle(900,10,-900,0.7), Tay2_len;
				vTaskDelay(1);
				if(!wantExit()) break;
					}
		...
		// quay mam sang tay 3
				...
				while(CB_Cap_Thanh_Sau == 0 || (abs(bientrochansauValue - target_chan_sau) > 40))	 {
				if(CB_ROI_4  == 0 && CB_ROI_2 == 0)	robotRunAngle(300,22,-900,0.7), Tay1_len;
				else																robotRunAngle(900,10,-900,0.7), Tay1_len;
				vTaskDelay(1);
				if(!wantExit()) break;
					}
...
void chuan_bi_gap_thang_do_9 (void) {
		...
		su_dung_chan(265);
			if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				/// chay toi thi tat qua trai	
					robotRunAngle(1800,14,-900,0.8);
					for(i=0;i<150;i++)
					{
...
void chuan_bi_gap_thang_do_2(void) {
			...
			if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
					while( lazeSauValue > 130  )	
					{	
					if(lazeTraiValue > vitri_tay41)			robotRunAngle(1450,20,-900,0.7);
					...
					while( CB_Cap_Thanh_Sau == 0 )	
					{	
					if(lazeTraiValue > vitri_tay41)			robotRunAngle(1450,14,-900,0.7);
					else																robotRunAngle(900,10,-900,0.7), Tay2_len;
					vTaskDelay(1);
					if(!wantExit()) break;
								}
				...
				/// chay toi thi tat qua trai	
					...
					/// chay toi thi tat qua phai
					robotRunAngle(0,14,-900,0.8);
					for(i=0;i<150;i++)
					{
...
void chuan_bi_gap_trai_200_tren_2_do (void ) {
	if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			...
			for(i=0;i<1550;i++) {
				while( lazeSauValue > 132 )	
				{	
				if(lazePhaiValue > vitri_tay23_phai_laser_GapQua)			robotRunAngle(400,20,-900,0.7);
				else																									robotRunAngle(900,14,-900,0.7), Tay2_len;
				vTaskDelay(1);
				if(!wantExit()) break;
						}
				}
			...
			for(i=0;i<1550;i++) {
				...
				{	
				if(lazePhaiValue > vitri_tay23_phai_laser_GapQua)			robotRunAngle(400,20,-900,0.7);
				else																									robotRunAngle(900,14,-900,0.7), Tay1_len;
				vTaskDelay(1);
				if(!wantExit()) break;
						}
				}
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			...
			for(i=0;i<1550;i++) {
				while( CB_Cap_Thanh_Sau == 0 || (abs(bientrochansauValue - target_chan_sau) > 100) )	{
						if(CB_ROI_1  == 0 && CB_ROI_3 == 0)	robotRunAngle(1450,14,-900,0.7);
						else																robotRunAngle(900,10,-900,0.7), Tay2_len;
						vTaskDelay(1);
						if(!wantExit()) break;
									}
			...
			for(i=0;i<150;i++) {
						while( CB_Cap_Thanh_Sau == 0)	
						{	
						if(lazePhaiValue > vitri_tay23)			robotRunAngle(300,14,-900,0.7);
						else																robotRunAngle(900,10,-900,0.7), Tay2_len;
						vTaskDelay(1);
						if(!wantExit()) break;
									}
...
void chuan_bi_gap_phai_200_duoi_do_5 (void ) {
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			...
			//// gap duoi lan 3
					...
					while( lazeSauValue > 132 )	 {
					if(CB_ROI_1  == 0 && CB_ROI_3 == 0)	robotRunAngle(1450,25,-900,0.7);
					else																robotRunAngle(900,15,-900,0.7);
					vTaskDelay(1);
					if(!wantExit()) break;
								}
					robotRunAngle(1800,20,-900,0.7);
					for(i=0;i<150;i++)
					{
						while(CB_ROI_3 == 0 )	
						{	
...
void qua_phai_xuong_bac_200_4_do (void) {
		...
		int di_cheo_41 = 0;
		int di_cheo_23 = 0;
		if (TinHieu_QuaPhai == 1   && (CB_ROI_3 == 0) && (bientrochansauValue > 400)) { // th vua gap trc xong
				time_41 = 8000;
				time_23 = 8000;
				di_cheo_41 = -450;
				di_cheo_23 = -1350;
		}
		else if (TinHieu_QuaPhai == 1  && (CB_ROI_3 == 1) && (bientrochansauValue > 400)) { /// dag o sap mep chan cao
				time_41 = 8000;
				time_23 = 8000;
				di_cheo_41 = -450;
				di_cheo_23 = -450;
		}
		else if (TinHieu_QuaPhai == 1  && (CB_ROI_3 == 1) && (bientrochansauValue < 300)) { /// dag o sap mep chan thap
				time_41 = 4000;
				time_23 = 4000;
				di_cheo_41 = 450;
				di_cheo_23 = -450;
...
void qua_phai_xuong_bac_200_5_do (void) {
		...
		else if (TinHieu_QuaPhai == 1 && CB_Ha_Sau == 0 && (CB_ROI_3 == 1) ) { // dag o sap mep
				time_41 = 4000;
				time_23 = 4000;
				di_cheo_41 = 450;
				di_cheo_23 = -450;
...
void qua_phai_xuong_bac_200_7_do (void) {
		...
		else if (TinHieu_QuaPhai == 1 && CB_Ha_Sau == 0  && (CB_ROI_3 == 1) ) { // dag o giua o
				time_41 = 3000;
				time_23 = 3000;
				di_cheo_41 = 450;
				di_cheo_23 = 1350;
