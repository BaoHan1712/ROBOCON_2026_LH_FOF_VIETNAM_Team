...
int	Min_tay_gat1 = 96, Max_tay_gat1 = 794, target_tay_gat1;
int	Min_tay_gat2 = 95, Max_tay_gat2 = 792, target_tay_gat2; // max + 6
...
void Gat_2()
{
	...
	if (abs(bientrodaytay2Value - target_tay_gat2) > 4)
	{
		...
		speed_temp = abs(bientrodaytay2Value - target_tay_gat2)*22;
	...
	void Xoay_tay_kep()
{
	...
	if ((abs(bientroxoaytayValue - target_xoay_tay) > 2) && (abs(bientrodaytay1Value - vitri_tay1home) < 20) && (abs(bientrodaytay2Value - vitri_tay2home) < 20))
	{
		...
		speed_temp = abs(bientroxoaytayValue - target_xoay_tay)*3;
...
void chuan_bi_thang_xanh_2(void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
					...
					{	
					if(lazeTraiValue > vitri_tay41)			robotRunAngle(-650,14,900,0.7);
					...
					if(!wantExit()) break;
						...
						while( CB_Cap_Thanh_Sau == 0 ||  (abs(bientrochansauValue - target_chan_sau) > 30))	
						{	
						if(lazePhaiValue > vitri_tay23)			robotRunAngle(-1550,14,900,0.7);
						else																robotRunAngle(-900,10,900,0.7);
						vTaskDelay(1);
						if(!wantExit()) break;
									}
...
void chuan_bi_gap_thang_xanh_3(void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				if(CB_ROI_3  == 0 && CB_ROI_1 == 0)	robotRunAngle(-450,15,900,0.7);
				else																robotRunAngle(-900,13,900,0.7);
				vTaskDelay(1);
				if(!wantExit()) break;
					}
				}
		...
		// quay mam sang tay 2
				...
				while(CB_Cap_Thanh_Sau == 0 || (abs(bientrochansauValue - target_chan_sau) > 100))	 {
				if(CB_ROI_4  == 0 && CB_ROI_2 == 0)	robotRunAngle(-1650,15,900,0.7);
				else																robotRunAngle(-900,13,900,0.7);
				vTaskDelay(1);
				if(!wantExit()) break;
					}
...
void qua_trai_len_bac_200_cua_vao(void) {
	...
	if ( TinHieu_ChuanBi_GapThang == 1 ) {
				...
				chinh_lai_vi_tri_laser_phai_custom(vi_tri_cua_rung_xanh_2_lazer_phai_tay_41 , 1000, 5, 50, 5);
				robotRunAngle(-900,15,900,0.8);
				for(i=0;i<1050;i++)	
				{	
					while( CB_Cap_Thanh_Sau == 0)	{vTaskDelay(1); if(!wantExit())	break;}
			...
			if (chay_ngang_qua_o1_xanh == 0) {
					...
					robotStop(0);
					chinh_lai_vi_tri_laser_phai_custom(vi_tri_cua_rung_xanh_2_lazer_phai_tay_41 - 15, 1000, 5, 45, 4);
			}
					...
					chinh_lai_vi_tri_laser_phai_custom(vi_tri_cua_rung_xanh_1_lazer_phai_tay_41 - 15, 1000, 5, 45, 4);
					}
				}
...
void qua_phai_len_bac_200_cua_vao(void) {
	...
	if ( TinHieu_ChuanBi_GapThang == 1 ) {
				...
				while(abs(ENCODER_FR()) + abs(ENCODER_FL()) < 10000)	{
							vTaskDelay (5); if(!wantExit())	break;}
				robotStop(0);
				chinh_lai_vi_tri_laser_phai_custom(vi_tri_cua_rung_xanh_2_lazer_phai_tay_41 , 1000, 5 , 50, 4);
...
void gap_tay1_bac_400(void) 
{
    ...
    do {
        ...
        speed_tay_gat1 = 250;
        target_tay_gat1 = (Max_tay_gat1 - 95);
        for(i = 0; i < 50; i++) { 
        ...
        speed_tay_gat1 = 200;
        target_tay_gat1 = (Max_tay_gat1 - 48);
        vTaskDelay(7000); 
        Kep_phai_1_vao;
        vTaskDelay(2500);
        Tay1_xuong;
...
void gap_tay4(void) 
{
    ...
    } while (!success && retry_count < 5 && wantExit());
}
...
void gap_tay1(void) 
{
    ...
    do {
        ...
        speed_tay_gat1 = 250;
        target_tay_gat1 = Max_tay_gat1 - 83;
        ...
        speed_tay_gat1 = 150;
        target_tay_gat1 = (Max_tay_gat1 - 26);
        vTaskDelay(7000); 
        Kep_phai_1_vao;
        vTaskDelay(2500);
        Tay1_xuong;
...
void gap_tay4_duoi(void) 
{
    ...
    Tay2_len;
    speed_tay_gat2 = 250;
    target_tay_gat2 = Min_tay_gat2 + 65;
...
void gap_tay1_duoi(void) 
{
    ...
    Kep_phai_1_ra;
    speed_tay_gat1 = 200;
    target_tay_gat1 = Max_tay_gat1 - 40;
    ...
    speed_tay_gat1 = 50;
    target_tay_gat1 = Max_tay_gat1 - 14;
    vTaskDelay(5000);
    ...
    if (check_hop_1 == 0) {
        do {
            ...
            speed_tay_gat1 = 250;
            target_tay_gat1 = Max_tay_gat1 - 68; 
...
void gap_tay2_duoi(void) 
{
    ...
    Kep_phai_2_ra;
    speed_tay_gat2 = 250;
    target_tay_gat2 = Max_tay_gat2 - 45;
    ...
    if (check_hop_2 == 0) {
        do {
            ...
            speed_tay_gat2 = 250;
            target_tay_gat2 = Max_tay_gat2 - 62; 
...
void gap_tay3_duoi(void)
{
    ...
    Tay1_len;
    speed_tay_gat1 = 250;
    target_tay_gat1 = Min_tay_gat1 + 52;
    ...
    if (check_hop_3 == 0) {
        do {
            ...
            speed_tay_gat1 = 250;
            target_tay_gat1 = Min_tay_gat1 + 70;
...
void test_lui_1 (void ) {
			robotRunAngle(600,16,-900,0.8);
			vTaskDelay(8500);
}

void test_lui_2 (void ) {
			robotRunAngle(-150,13,-900,0.8);
			vTaskDelay(7000);
}
