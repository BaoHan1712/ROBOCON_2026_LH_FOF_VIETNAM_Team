...
#define Gat_tay1_len				 									DATA_SPEED[26]=0
#define Gat_tay1_xuong												DATA_SPEED[26]=1
...
#define Gat_tay2_len				 			DATA_SPEED[42]=1
#define Gat_tay2_xuong						DATA_SPEED[42]=0 
...
//=============================ADC DMI======================================//
#define cam_bien_laze_phai			       			 _ADC1_Value[0]
#define cam_bien_laze_trai			       			 _ADC1_Value[1]

#define bien_tro_chan_truoc									 _ADC1_Value[2]//pinA4	
#define bien_tro_chan_sau								 	 	 _ADC1_Value[3]//pinAA5	 //OK0
#define bien_tro_xoay_tay								 		 _ADC1_Value[4]//pinA6
#define Quang_tro								 	 	 				 _ADC1_Value[5]

#define cam_bien_laze_truoc							 		 _ADC1_Value[6]  //OK
#define cam_bien_laze_sau							 		   _ADC1_Value[9]  //OK 

#define bien_tro_gat1												 _ADC1_Value[8]//pinA8
#define bien_tro_gat2												 _ADC1_Value[7]//pinA9
...
#define  CB_ROI_1														GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_12)
//#define  CB_ROI_2													GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_6)//ok
#define  CB_kep													    GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_1)//ok
#define  CB_ROI_4														GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_11)
...
//	GPIO_Init(GPIOA, &GPIO_InitStructure);
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_6, 5, sample_time_adc1);//
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 3:
										...
										break;
									case 4:
										HMI_DMI("Tro day tay 1 ",bientrodaytay1Value,4);
											break;

									case 5:
										HMI_DMI("Tro day tay 2 ",bientrodaytay2Value,5);  
										break;
									case 6:
									...
									case 12:
										...
										break;
									case 13:
										HMI_DMI("Lazer sau",lazeSauValue,13); 
										break;
									case 14:
