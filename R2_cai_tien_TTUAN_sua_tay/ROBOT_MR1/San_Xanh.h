...
{				
				...
				for(i=0;i<250;i++)
				{
					...
					{	
						...
						Bam_thanh_laser_phai(55,0,0,vu_khi,2,150,30);
...
//				robotStop(0);
//				chinh_lai_vi_tri_VK(vitri, 1000, 10, 90, 2);
				robotStop(2);
...
//				
	...
	if (TinHieu_ChuanBi_GapThang == 1) {
			chinh_lai_vi_tri_laser_phai_custom(vi_tri_cua_rung_xanh_1_lazer_phai_tay_41  , 1000, 10 , 70, 2 );
	}
	else if (TinHieu_ChuanBi_GapThang == 0) {
			chinh_lai_vi_tri_laser_phai_custom(vi_tri_cua_rung_xanh_1_lazer_phai_tay_41 , 1000, 10 , 70, 4);
	}
	if (block_pha == 1) {
//			SEND_UART (4,1);
			cho_r1 = 1;
...
//				
	...
	if (TinHieu_ChuanBi_GapThang == 0) {
			chinh_lai_vi_tri_laser_phai_custom(vi_tri_cua_rung_xanh_2_lazer_phai_tay_41  , 1000, 8, 70, 5);
	}
	else if (TinHieu_ChuanBi_GapThang == 1) {
			chinh_lai_vi_tri_laser_phai_custom(vi_tri_cua_rung_xanh_2_lazer_phai_tay_41  , 1000, 8, 70, 2);
	}
	robotStop(0); 
		if (block_pha == 2) {
	SEND_UART (4,1);
...
//				
	...
	robotStop(0);
	if (TinHieu_ChuanBi_GapThang == 1) {
			chinh_lai_vi_tri_laser_phai_custom(vi_tri_cua_rung_xanh_3_lazer_phai_tay_41  , 1000, 8, 65, 2);
	}
	else if (TinHieu_ChuanBi_GapThang == 0) {
			chinh_lai_vi_tri_laser_phai_custom(vi_tri_cua_rung_xanh_3_lazer_phai_tay_41  , 1000, 8, 65, 4);
	}
...
void Vao_rung_mai_1_xanh(int vitri)
{
	...
	target_chan_sau = Min_chan_sau + 250;
		...
		for(i=0;i<250;i++)
		{
			...
			{	
			Bam_thanh_laser_phai_cua_vao(65,-900,900,vitri,5,180,30);
				vTaskDelay (1);
				if(!wantExit())	break;
			}
				}
			...
			for(i=0;i<250;i++)
					{
						...
						{	
							Bam_thanh_laser_phai_cua_vao(25,-900,900,vitri - 5,2,150,30);
							vTaskDelay (1);
							if(!wantExit())	break;
						}
				}
				...
				for(i=0;i<250;i++)
				{
					...
					{	
						Bam_thanh_laser_phai_cua_vao(10,-900,900,vitri - 5,2,150,30);
						if(!wantExit())	break;
					}
				}
				robotStop(0);
				...
				if (block_pha == 1) {
					...
					for(i=0;i<250;i++)
					{
						while(lazeSauValue > 135)	
						{	
							Bam_thanh_laser_phai_cua_vao(25,-900,900,vitri ,2,180,30);
							vTaskDelay (1);
							if(!wantExit())	break;
						}
				}
					...
					for(i=0;i<250;i++)
				{
					...
					{	
						...
						Bam_thanh_laser_phai_cua_vao(10,-900,900,vitri,2,180,30);
						if(!wantExit())	break;
					}
				}
				robotStop(30); 	
		...
		for(i=0;i<250;i++)
				{
					...
					{	
						Bam_thanh_laser_phai(45,-900,900,vitri -4,2,-180,30);
						vTaskDelay (1);
						if(!wantExit())	break;
					}
				}	
			...
			for(i=0;i<250;i++)
				{
					while(lazeSauValue > 135)	
					{	
						Bam_thanh_laser_phai(25,-900,900,vitri - 4,3,-150,30);
						vTaskDelay (1);
						if(!wantExit())	break;
					}
				}	
			for(i=0;i<1550;i++)
						{
							while(  CB_Cap_Thanh_Sau == 0)	
							{	
								Bam_thanh_laser_phai(10,-900,900,vitri - 4,2,-150,30);
								if(!wantExit())	break;
								vTaskDelay (1);
							}
						}
				...
				for(i=0;i<250;i++)
				{
					...
					{	
						Bam_thanh_laser_phai(25,-900,900,vitri,2,-180,30);
						vTaskDelay (1);
						if(!wantExit())	break;
					}
			}
				...
				for(i=0;i<1550;i++)
						{
							while( CB_Cap_Thanh_Sau == 0)	
							{	
								Bam_thanh_laser_phai(10,-900,900,vitri,2,-150,30);
								if(!wantExit())	break;
								vTaskDelay (1);
							}
						}
		...
		for(i=0;i<250;i++)
					{
						while(lazeSauValue > 155)	
						{	
							Bam_thanh_laser_trai(45,-900,900,vitri + 5,4,150,30);
							vTaskDelay (1);
							if(!wantExit())	break;
						}
				}
			...
			for(i=0;i<250;i++)
					{
						while(lazeSauValue > 135)	
						{	
							Bam_thanh_laser_trai(25,-900,900,vitri + 10,2,150,30);
							vTaskDelay (1);
							if(!wantExit())	break;
						}
				}
				...
				for(i=0;i<1550;i++)
							{
									while( CB_Cap_Thanh_Sau == 0)	
								{	
									Bam_thanh_laser_trai(10,-900,900,vitri + 10,2,150,30);
									vTaskDelay (1);
									if(!wantExit())	break;
...
void Leo_bac_200_xanh_5(void) {	
		...
		if (TinHieu_ChuanBi_GapThang == 0 && TinHieu_ChuanBi_GapTrai == 0 && TinHieu_ChuanBi_GapPhai == 0 && TinHieu_QuaPhai == 0 && TinHieu_QuaTrai == 0) {
				...
				for(i=0;i<1550;i++)
						{
					while(CB_Ha_Sau == 1 ||  CB_Cap_Thanh_Sau == 0 || (abs(bientrochansauValue - target_chan_sau) > 40) )	
							{	
								if(!wantExit())	break;
								vTaskDelay (1);
							}
...
void chuan_bi_gap_thang_xanh_9 (void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				while (CB_ROI_3  == 0 )	 {
					...
					while( CB_Ha_Sau == 0 || (abs(bientrochansauValue - target_chan_sau) > 40)) 
					{	
					if(lazePhaiValue > vitri_tay23)			robotRunAngle(-1400,18,900,0.7);
					else																robotRunAngle(-900,20,900,0.7);
					vTaskDelay(1);
					if(!wantExit()) break; }
			}
...
void chuan_bi_gap_trai_200_tren (void ) {
	if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			...
			for(i=0;i<150;i++)
					{
				while(lazeTruocValue < 145 || (abs(bientrochansauValue - target_chan_sau) > 300))	
						{	
							vTaskDelay (1);
							if(!wantExit())	break;
						}
  ...
  target_xoay_tay = vi_tri_dat_hop_1_2;
	...
	for(i=0;i<150;i++)		
	{
		...
		if (vi_tri_chay_ngang_xanh == 10) {
			chinh_lai_vi_tri_laser_phai_custom(182, 1000, 15, 72, 2);
	}
	else if (vi_tri_chay_ngang_xanh == 11) { 
			chinh_lai_vi_tri_laser_phai_custom(182, 1000, 12, 72, 4);
	}
	else if ( vi_tri_chay_ngang_xanh == 12) { 
			chinh_lai_vi_tri_laser_phai_custom(182, 1000, 8, 63, 4);
	}
	...
	if (mode_cay_diem == 2 ) {
		...
		{	
			...
			{	
					...
					{	
						Bam_laser_sau(40,0,900, vitri + 33, 3, -150, 10);
						vTaskDelay(1); 
						if(!wantExit())	break;
					}
			}	
		for(i=0;i<550;i++)	
			{	
					...
					{	
						Bam_laser_sau(25,0,900, vitri + 33, 3, -150, 10);
						vTaskDelay(1); 
						if(!wantExit())	break;
					}
			}	
			...
			{	
					...
					{	
						Bam_laser_sau(10,0,900, vitri + 33, 2, -150, 10);
...
void dat_qua_tay_1_2_xanh(void) {
    ...
    else if ((check_hop_2 == 0) && !da_dat_tay_2) {
        speed_tay_gat2 = 100;
...
void dat_qua_tay_4_3_xanh(void) {
    ...
    else if ((check_hop_3 == 1) && !da_dat_tay_3) {
        speed_tay_gat1 = 100;
        target_tay_gat1 = vitri_tay1home - 90;
...
void dat_hop_vao_o_tang2 (void) {
		if (tin_hieu_dat_hop_3_4 == 1 ) {
				if (check_hop_4 == 1) {
					...
					dat_hop4_2(520, 325, 5, 4);
					vTaskDelay(3000); 
					speed_tay_gat2 = 250;
					target_tay_gat2 = vitri_tay2home ;
				}
				else if (check_hop_3 == 1) {
					speed_tay_gat2 = 120;
				...
				if (check_hop_1 == 0) {
						...
						dat_hop1_3(520, 555, 5, 1);
						vTaskDelay(3000); 
						speed_tay_gat1 = 250;
						target_tay_gat1 = vitri_tay1home ;
				}
				else if (check_hop_2 == 0) {
...
void chuan_bi_dat_hop_tang3 (void) {
		if (tin_hieu_dat_hop_3_4 == 1 && tay_4_co_qua == 1 ) {
				speed_tay_gat1 = 100;
        target_tay_gat1 = vitri_tay1home + 75;
				Tay2_len;
				for(i=0;i<50;i++)	{ 
				...
				speed_tay_gat2 = 100;
        target_tay_gat2 = vitri_tay2home - 75;
				Tay1_len;
				for(i=0;i<50;i++)	{ 
...
void tudonghoantoan(void) {
		...
		Xuat_Phat_Lay_Vu_Khi_Xanh(163, -1700, 198);
    mo_vk_san_xanh();
    
    if (da_lay_vk == 2) {    
        Run_All_Blocks_From_Queue_san_xanh();
    }
		if (hoan_thanh_chay_rung == 1 ) DatKFSxanh(149),hoan_thanh_chay_rung = 2 ;
...
void chon_o_nhat_hop_xanh(void) {
		...
		if (nhat_dat_hop == 1 ) {
				chinh_lai_vi_tri_laser_phai_zone3_do(187, 200, 4, 35);
			}
		else if (nhat_dat_hop == 2 ) {
				chinh_lai_vi_tri_laser_phai_zone3_do(219, 200, 4, 35);
			}
		else if (nhat_dat_hop == 3 ) {
				chinh_lai_vi_tri_laser_phai_zone3_do(250, 200, 4, 35);
			}
		else if (nhat_dat_hop == 4|| nhat_dat_hop == 5 || nhat_dat_hop == 6) {
				chinh_lai_vi_tri_laser_sau_zone3(150, 1000);
				chinh_lai_vi_tri_laser_phai_zone3_do(185, 200, 4, 35);
			}
...
void nhat_hop_zone3_xanh (void) {
    ...
    robotRunAngle(1800, 55, 0, 0.5);
    RESET_ENCODER(); 
		while(abs(ENCODER_FR()) + abs(ENCODER_FL()) < 19000)	{vTaskDelay (5); if(!wantExit())	break;}
		robotStop(100);
...
//    
    ...
    for (lap = 0; lap < 8; lap++) {
      // chuan bi lay lan tiep theo
				...
				speed_tay_xoay = 220;
				target_xoay_tay = vi_tri_tay_43;
				chinh_lai_vi_tri_laser_phai_zone3_do(174, 500, 5, 50);
        chinh_lai_vi_tri_laser_sau_zone3(247, 1000);
        robotStop(0);
