...
//				if(X && L2 && !R2)							Kep_phai_3_ra;
//				if(SQUARE && L2 && !R2)					Kep_phai_3_vao;
//				if(O && L2 && !R2)								Tay1_len;
//				if(TRIANGLE&& L2 && !R2)					Test_gap();
			if(O && L2 && !R2 && Vi_tri == 0)								Xuat_Phat_Lay_Vu_Khi_Xanh(182,-1700),Vi_tri = 1 ;
...
//			if(SQUARE && L2 && !R2 && Vi_tri == 0)					Xuat_Phat_Lay_Vu_Khi_Xanh(229,1700),Vi_tri = 1;
				if(TRIANGLE && L2 && !R2) 										Vao_rung_mai_3_xanh(262);
				if(SQUARE && L2 && !R2) 											Vao_rung_mai_2_xanh(369);
//				if(X && L2 && !R2) 														Vao_rung_mai_2_xanh(369);
				if ( O && L2 && !R2 && Vi_tri == 1) 					Vao_rung_mai_1_xanh(373);
//Leo_bac_200
//Leo_bac_400		
//Xuong_bac_400		
// Vao_rung_mai_1_xanh(372);
//Vao_rung_mai_2_xanh(369);
// Vao_rung_mai_3_xanh(265);
		}
