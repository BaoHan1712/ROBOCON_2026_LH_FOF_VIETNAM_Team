...
int	Min_tay_gat1 = 100, Max_tay_gat1 = 770, target_tay_gat1;
int	Min_tay_gat2 = 103, Max_tay_gat2 = 768, target_tay_gat2;
...
void ve_home_2_tay (void) {
			...
			for(i=0;i<50;i++)	{ 
							while(abs(bientrodaytay1Value - target_tay_gat1) > ((vitri_tay1home- Min_tay_gat1) / 3 ) || abs(bientrodaytay2Value - target_tay_gat2) > ((vitri_tay1home- Min_tay_gat1) / 3 ) )	{vTaskDelay(1); if(!wantExit())	break;}
					}
}
...
//	target_chan_sau = 240;//home lay vk
	...
	target_tay_gat1 = vitri_tay1home;
//	speed_tay_gat2 = 50;
//	target_tay_gat2 = 575//home lay vk
//	
//	speed_tay_gat1 =50;
//	target_tay_gat1 = 574;
...
{		
		...
		vTaskDelay (1000);
				...
				speed_tay_gat1 = 250;
		target_tay_gat1 = (Max_tay_gat1- 30);
		for(i=0;i<50;i++)	{ 
						while(abs(bientrodaytay1Value - target_tay_gat1)> 10 )	{vTaskDelay(1); if(!wantExit())	break;}
				}
		vTaskDelay (7000);
...
//					
			...
			speed_tay_gat2 = 250;
			target_tay_gat2 = Min_tay_gat2 + 28 ;
			for(i=0;i<550;i++)	{ 
...
{	
		speed_tay_xoay = 100;
					target_xoay_tay = vi_tri_tay_43 + 2;
					for(i=0;i<150;i++)	{ 
							while((abs(bientroxoaytayValue - target_xoay_tay) > 10) )	{vTaskDelay(1); if(!wantExit())	break;}
					}
		Kep_phai_3_ra;
