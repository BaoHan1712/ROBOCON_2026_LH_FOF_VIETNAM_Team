...
#define Kep_kfs_mo		 						DATA_SPEED[42]=0
#define Kep_kfs_dong							DATA_SPEED[42]=1 
#define	Kep_kfs										DATA_SPEED[43]
...
#define   XI_LANH_TAY_VAO								GPIO_WriteBit(GPIOB,GPIO_Pin_0,0) 
#define   XI_LANH_TAY_RA								GPIO_WriteBit(GPIOB,GPIO_Pin_0,1)//b0

#define   XI_LANH_TAY_LEN								GPIO_WriteBit(GPIOB,GPIO_Pin_6,1)//b6
#define   XI_LANH_TAY_XUONG							GPIO_WriteBit(GPIOB,GPIO_Pin_6,0)

#define   XI_LANH_KEP_DONG							GPIO_WriteBit(GPIOD,GPIO_Pin_15,0) // -- OKd15
#define   XI_LANH_KEP_MO								GPIO_WriteBit(GPIOD,GPIO_Pin_15,1)
...
#define  CB_THANH_TRAI													GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_10)
#define  CB_THANH_PHAI													GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_8)
#define  CB_CHAM_DUOI														GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_7)
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 8:
										...
										break;
									case 9:
										HMI_DMI("ENCODER CHAY ",ENCODER_CHAY(),9);
										break;
//										if(NUT_CHUYEN_SAN == 1){
...
//										break;
									case 10:	  
										HMI_DMI("do lech :",do_lech_px_2,10);
										break;
									case 11:
									...
									case 13:
										...
										break;
									case 14:
										HMI_DMI("GapThang: ",TinHieu_ChuanBi_GapThang,14);  
										break;		
									case 15:
