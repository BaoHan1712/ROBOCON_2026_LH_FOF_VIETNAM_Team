...
///// da di len roi chay ngang qua
		...
		{	
			...
			{	
				Bam_laser_sau(52,0,900, 136, 2, -100, 10);
				vTaskDelay(1); 
				if(!wantExit())	break;
			}
		}
...
////////======================================			
		...
		{	
			...
			{	
				Bam_laser_sau(55,0,900, 136, 2, -100, 10);
				vTaskDelay(1); 
				if(!wantExit())	break;
			}
		}
...
////////// =================================================
		...
		/////==========================////////////////////////
				...
				led_bao_hieu_on;
				run_encoder(5000, 0, 900, 40, 5, 2000, 50);
				robotStop(0);
	...
	if (mode_cay_diem == 2 ) {
		...
		{	
			...
			{	
					...
					{	
						Bam_laser_sau(45,0,900, vitri , 2, -200, 10);
						vTaskDelay(1); 
						if(!wantExit())	break;
					}
			}	
		...
		for(i=0;i<550;i++)	
			{	
					...
					{	
						Bam_laser_sau(25,0,900, vitri , 2, -180, 10);
						vTaskDelay(1); 
						if(!wantExit())	break;
					}
			}	
