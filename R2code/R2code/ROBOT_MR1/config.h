...
#define mor_lift_rear_up											DATA_SPEED[18]=0
#define mor_lift_rear_down					 					DATA_SPEED[18]=1
#define	mor_lift_rear					 								DATA_SPEED[19]

#define	DIA_CHI_START6											  DATA_SPEED[20]=255
#define	ID6																    DATA_SPEED[21]=6
#define mor_lift_front_up					 						DATA_SPEED[22]=1
#define mor_lift_front_down										DATA_SPEED[22]=0
...
//#define Quang_tro_on				 									DATA_SPEED[26]=0
//#define Quang_tro_off													DATA_SPEED[26]=1
//#define	Quang_tro							 								DATA_SPEED[27]
...
#define May_bom1_on				 				DATA_SPEED[42]=1
#define May_bom1_off							DATA_SPEED[42]=0 
#define	May_bom1										DATA_SPEED[43]


#define	DIA_CHI_START12						DATA_SPEED[44]=255 // -- OK
#define	ID12											DATA_SPEED[45]=12 
#define XI_LANH_HA_KEP				 		DATA_SPEED[46]=0
#define XI_LANH_NANG_KEP					DATA_SPEED[46]=1
...
//=============================ADC DMI======================================//
#define cam_bien_laze_trai			       			 _ADC1_Value[8]
#define cam_bien_laze_phai			       			 _ADC1_Value[7]
#define cam_bien_laze_truoc							 		 _ADC1_Value[6]  //OK 

#define bien_tro_xoay_tay								 		 _ADC1_Value[4]//pinA6
#define cam_bien_laze_truoc_nho							_ADC1_Value[0]//pinA2
//#define bien_tro_chan_sau										 _ADC1_Value[1]//pinA3
#define bien_tro_chan_truoc									 _ADC1_Value[2]//pinA4	
#define bien_tro_chan_sau								 	 	 _ADC1_Value[3]//pinAA5	 //OK
...
#define  CB_Ha_Sau													GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_11)//ok
...
#define  CB_tay1_giua												GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_7)
#define  CB_tay2_giua												GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_6)//ok
#define  CB_tay3_giua												GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_0)//ok
#define  CB_bung														GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_13)//ok
#define  CB_trai														GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_2)//ok
#define  CB_phai														GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_11)//ok
...
#define Tay3_xuong_on				Cylinder_ID9 |= bit_0_H
#define Tay3_xuong_off			Cylinder_ID9 &= bit_0_L

#define Tay3_len_on					Cylinder_ID9 |= bit_1_H
#define Tay3_len_off				Cylinder_ID9 &= bit_1_L

#define Tay2_xa_on					Cylinder_ID9 |= bit_2_H
#define Tay2_xa_off					Cylinder_ID9 &= bit_2_L
...
#define Tay3_day_ra					Cylinder_ID8 |= bit_2_H
#define Tay3_day_vao				Cylinder_ID8 &= bit_2_L

#define Tay2_day_ra					Cylinder_ID8 |= bit_3_H
#define Tay2_day_vao				Cylinder_ID8 &= bit_3_L

#define Tay1_day_ra					Cylinder_ID8 |= bit_4_H
#define Tay1_day_vao				Cylinder_ID8 &= bit_4_L

#define Tay2_xuong_on				Cylinder_ID8 |= bit_5_H
#define Tay2_xuong_off			Cylinder_ID8 &= bit_5_L

#define Tay2_len_on					Cylinder_ID8 |= bit_6_H
#define Tay2_len_off				Cylinder_ID8 &= bit_6_L
...
int		bientroxoaytayValue, bientronangtayValue,bientrochantruocValue,bientrochansauValue,bientrodaytayValue;
vu16 _ADC1_Value[10];
...
//	GPIO_Init(GPIOA, &GPIO_InitStructure);
	...
	#define sample_time_adc1 ADC_SampleTime_3Cycles
	
	ADC_RegularChannelConfig(ADC1, ADC_Channel_2, 1, sample_time_adc1);//a2
	ADC_RegularChannelConfig(ADC1, ADC_Channel_3, 2, sample_time_adc1);//a3
	ADC_RegularChannelConfig(ADC1, ADC_Channel_4, 3, sample_time_adc1);//a4
	ADC_RegularChannelConfig(ADC1, ADC_Channel_5, 4, sample_time_adc1);//a5
	ADC_RegularChannelConfig(ADC1, ADC_Channel_6, 5, sample_time_adc1);//a6
	ADC_RegularChannelConfig(ADC1, ADC_Channel_7, 6, sample_time_adc1);//a7
	
	ADC_RegularChannelConfig(ADC1, ADC_Channel_12, 7, sample_time_adc1);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_13, 8, sample_time_adc1);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_14, 9, sample_time_adc1);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_15, 10, sample_time_adc1);
...
void HMI_TRAN(vs32 _so_dong)
{
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
										...
										break;
									case 1:
										HMI_DMI("Tro chan Truoc: ",	bientrochantruocValue,1);
										break;

									case 2:
										HMI_DMI("Tro chan Sau:  ",bientrochansauValue,2);
										break;
									case 3:
									...
									case 5:
										HMI_DMI("count_data_uart ",count_data_uart4,5);  
										break;
									case 6:
...
//										}
										break;
									case 10:
										HMI_DMI("Lazer phai",lazePhaiValue,10);  					
										break;
									case 11:
										HMI_DMI("Lazer truoc ",lazeTruocValue,11);  						
										break;
									case 12:
										HMI_DMI("Lazer trai ",lazeTraiValue,12);
										//HMI_DMI("CTHT_BONG_LEN :",CTHT_BONG_LEN,13);   
										break;
									case 13:
										HMI_DMI("Lazer truoc nho",lazeTruocNhoValue,13); 
										break;
									case 14:
										HMI_DMI("Quang tro:",quangTroValue,14);  
										break;		
									case 15:
										HMI_DMI("IMU:", -IMU,15);
										break;	
