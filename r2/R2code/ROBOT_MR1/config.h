...
#define Mor_FrontRight_thuan 									DATA_SPEED[6]=0
#define Mor_FrontRight_nghich									DATA_SPEED[6]=1
...
#define Cylinder_Daybongra				DATA_SPEED[50]=0
#define Cylinder_Daybongve				DATA_SPEED[50]=1
#define	Cylinder_L							  DATA_SPEED[51]
...
int		bientroxoaytayValue, bientronangtayValue,bientrochantruocValue,bientrochansauValue;
vu16 _ADC1_Value[8];
