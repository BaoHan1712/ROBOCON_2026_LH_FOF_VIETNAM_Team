...
int	Min_tay_gat1 = 98, Max_tay_gat1 = 776, target_tay_gat1;
int	Min_tay_gat2 = 95, Max_tay_gat2 = 772, target_tay_gat2;
...
void Nang_nhanh	(void) {
	speed_chan_sau = 78;
	speed_chan_truoc = 113;
}

void Nang_cuc_nhanh	(void) {
	speed_chan_sau = 120;
	speed_chan_truoc = 172;
}
...
void ve_home_2_tay (void) {
			...
			for(i=0;i<50;i++)	{ 
				while(abs(bientrodaytay1Value - target_tay_gat1) > ((vitri_tay1home- Min_tay_gat1) / 3 ) || abs(bientrodaytay2Value - target_tay_gat2) > ((vitri_tay2home- Min_tay_gat2) / 3 ) )	
...
void di_tren_buc_khong_thanh_2_ben (void) {
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
				...
				if(CB_ROI_3  == 0 && CB_ROI_1 == 0)	robotRunAngle(-450,19,900,0.7);
		...
		// quay mam sang tay 2
				...
				while(CB_vtri_leo == 0 ||  CB_Ha_Sau == 0) {
				if(CB_ROI_2  == 0 && CB_ROI_4 == 0)	robotRunAngle(-1650,19,900,0.7);
				else																robotRunAngle(-900,15,900,0.7);
				vTaskDelay(1);
				if(!wantExit()) break;
							}
...
//	vTaskDelay(3000);
	...
	speed_chan_sau = 250;
	target_chan_sau = Min_chan_sau + 25;
...
//			KT_Ha_Tay = 1;
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
					...
					{	
					if(lazePhaiValue > vitri_tay41)			robotRunAngle(-450,15,900,0.7);
					...
					chinh_lai_vi_tri_laser_trai(vitri_tay41, 1000);	
						...
						while( CB_Cap_Thanh_Sau == 0 ||  (abs(bientrochansauValue - target_chan_sau) > 10))	
						{	
						if(lazeTraiValue < vitri_tay23)			robotRunAngle(-1550,15,900,0.7);
						else																robotRunAngle(-900,10,900,0.7);
						vTaskDelay(1);
						if(!wantExit()) break;
									}
...
//	
//	robotStop(0);
	robotRunAngle(Angle,12,Robot_Angle,0.2);
	...
	for(i=0;i<50;i++)		
	{
		while(abs(bientrochansauValue - target_chan_sau) > 4)	{vTaskDelay(5); if(!wantExit())	break;}
	}
...
//		}
  ...
  robotStop(0);
	...
	robotRunAngle(Angle,20,Robot_Angle,0.2);
	for(i=0;i<250;i++)	
	{
	while(CB_ROI_2 == 1  || CB_ROI_3 == 1)	{vTaskDelay(1); if(!wantExit())	break;}
	}
...
{	
	...
	for(i=0;i<500;i++)
	{	
		while(CB_Ha_Sau == 0 || CB_vtri_leo == 0 || (CB_ROI_1 == 0  && CB_ROI_4 == 0))	{vTaskDelay(5); if(!wantExit())	break;}
	}
...
//		}
	...
	for(i=0;i<250;i++)		
	{
		while(abs(bientrochantruocValue - target_chan_truoc) > 35)	{vTaskDelay(1); if(!wantExit())	break;}
	}
	...
	for(i=0;i<50;i++)		
	{
		while(abs(bientrochantruocValue - target_chan_truoc) > 15)	{vTaskDelay(1); if(!wantExit())	break;}
	}
...
void qua_trai_len_bac_200_cua_vao(void) {
	...
	if ( TinHieu_ChuanBi_GapThang == 1 ) {
			...
			if (chay_ngang_qua_o1_xanh == 0) {
					chinh_lai_vi_tri_laser_phai(vi_tri_cua_rung_xanh_2_lazer_phai_tay_41 - 15, 1000);
			}
...
void gap_tay4_bac_400(void) 
{
    ...
    do {
        ...
        for(i=0; i<50; i++) { 
            while(abs(bientrodaytay2Value - target_tay_gat2) > 10) { vTaskDelay(1); if(!wantExit()) return; }
        }
        for(i=0; i<550; i++) { 
            while(CB_xilanh_tay_2 == 1) { vTaskDelay(1); if(!wantExit()) return; }
        }
                
        Ktra_vtri_kep4(); 
        
        speed_tay_gat2 = 250;
        target_tay_gat2 = (Min_tay_gat2 + 48);
        vTaskDelay(7000); 
        for(i=0; i<500; i++) { 
            while (abs(bientrodaytay2Value - (Min_tay_gat2 + 48)) > 10) 
            {
                speed_tay_gat2 = 250;
                target_tay_gat2 = Min_tay_gat2 + 110;
        ...
        target_tay_gat2 = vitri_tay2home;
        for(i=0; i<50; i++) { 
            while(abs(bientrodaytay2Value - target_tay_gat2) > ((vitri_tay2home - Min_tay_gat2) / 1.5))    
            { vTaskDelay(1); if(!wantExit()) return; }
        }
...
void gap_tay1_bac_400(void) 
{
    ...
    do {
        ...
        for(i = 0; i < 50; i++) { 
            while(abs(bientrodaytay1Value - target_tay_gat1) > 10) { vTaskDelay(1); if(!wantExit()) return; }
        }
        for(i = 0; i < 50; i++) { 
            while(CB_xilanh_tay_1 == 1) { vTaskDelay(1); if(!wantExit()) return; }
        }
        ...
        for(i = 0; i < 50; i++) { 
            while(abs(bientrodaytay1Value - (Max_tay_gat1 - 35)) > 5) {
                speed_tay_gat1 = 250;
                target_tay_gat1 = Max_tay_gat1 - 70;
        ...
        target_tay_gat1 = vitri_tay1home;
        for(i = 0; i < 50; i++) { 
            while(abs(bientrodaytay1Value - target_tay_gat1) > ((vitri_tay1home - Min_tay_gat1) / 1.5)) {
                vTaskDelay(1); if(!wantExit()) return;
            }
        }
...
void gap_tay2_bac_400(void) 
{
    ...
    do {
        ...
        target_xoay_tay = 692;
        for(i = 0; i < 50; i++) { 
            while(bientroxoaytayValue < 690) { vTaskDelay(1); if(!wantExit()) return; }
        }
        ...
        speed_tay_gat2 = 250;
        target_tay_gat2 = (Max_tay_gat2 - 30);
        vTaskDelay(7000); 
            
        for(i = 0; i < 50; i++) { 
            while(abs(bientrodaytay2Value - (Max_tay_gat2 - 30)) > 5) {
                speed_tay_gat2 = 200;
                target_tay_gat2 = Max_tay_gat2 - 95;
...
void gap_tay4(void) 
{
    ...
    do {
        ...
        speed_tay_gat2 = 40;
        target_tay_gat2 = Min_tay_gat2 + 30;
        vTaskDelay(7000); 

        for(i=0; i<500; i++) { 
            while (abs(bientrodaytay2Value - (Min_tay_gat2 + 30)) > 4) 
            {
                speed_tay_gat2 = 250;
...
void gap_tay1(void) 
{
    ...
    do {
        ...
        speed_tay_gat1 = 230;
        target_tay_gat1 = Max_tay_gat1 - 60;
                
        for(i=0; i<550; i++) { 
            while(CB_xilanh_tay_1 == 1) { vTaskDelay(1); if(!wantExit()) return; }
        }
        for(i=0; i<50; i++) { 
            while(abs(bientrodaytay1Value - target_tay_gat1) > 5) { vTaskDelay(1); if(!wantExit()) return; }
        }
        ...
        for(i=0; i<50; i++) { 
            while(abs(bientrodaytay1Value - (Max_tay_gat1 - 5)) > 5) {
                speed_tay_gat1 = 250;
                target_tay_gat1 = Max_tay_gat1 - 60;
        ...
        target_tay_gat1 = vitri_tay1home;
        for(i=0; i<50; i++) { 
            while(abs(bientrodaytay1Value - target_tay_gat1) > ((vitri_tay1home - Min_tay_gat1) / 2))
            { vTaskDelay(1); if(!wantExit()) return; }
        }
...
void gap_tay2(void) 
{
    ...
    do {
        ...
        for(i=0; i<50; i++) { 
            while(abs(bientrodaytay2Value - (Max_tay_gat2 - 5)) > 5) {
                speed_tay_gat2 = 200;
                target_tay_gat2 = Max_tay_gat2 - 60;
...
void gap_tay3(void)
{
    ...
    do {
        ...
        for(i=0; i<50; i++) { 
            while(abs(bientrodaytay1Value - (Min_tay_gat1 + 45)) > 4) {
                speed_tay_gat1 = 250;
...
void gap_tay4_duoi_trai_phai(int vi_tri) 
{
    ...
    do {
        ...
        for(i=0; i<150; i++) { 
            while((abs(bientroxoaytayValue - target_xoay_tay) > 10)) { vTaskDelay(1); if(!wantExit()) return; }
        }
        ...
        for(i=0; i<550; i++) { 
            while(abs(bientrodaytay2Value - Min_tay_gat2) > 5) 
            {
                speed_tay_gat2 = 250;
                target_tay_gat2 = Min_tay_gat2 + 35;
                for(i=0; i<50; i++) { 
...
void gap_tay3_duoi_trai_phai(int vi_tri)
{
    ...
    do {
        ...
        Tay1_len;
        speed_tay_gat1 = 250;
        target_tay_gat1 = Min_tay_gat1 + 60;
        for(i=0; i<50; i++) { 
            while(CB_xilanh_tay_1 == 1) { vTaskDelay(1); if(!wantExit()) return; }
        }
        ...
        for(i=0; i<50; i++) { 
            while(abs(bientrodaytay1Value - Min_tay_gat1) > 5) {
                speed_tay_gat1 = 250;
                target_tay_gat1 = Min_tay_gat1 + 60;
                for(i=0; i<50; i++) { 
...
void gap_tay4_duoi(void) 
{
    ...
    do {
        ...
        for(i=0; i<50; i++) { 
            while(abs(bientrodaytay2Value - (Min_tay_gat2 + 18)) > 4) {
                speed_tay_gat2 = 250;
                target_tay_gat2 = Min_tay_gat2 + 80;
                for(i=0; i<550; i++) { 
                    while(abs(bientrodaytay2Value - target_tay_gat2) > 4) {
                        vTaskDelay(1); 
                        if(!wantExit()) return;
                    }
                }
...
void gap_tay1_duoi(void) 
{
    ...
    do {
        ...
        // --- ---
        for(i=0; i<50; i++) { 
            while(abs(bientrodaytay1Value - Max_tay_gat1) > 4) {
                speed_tay_gat1 = 250;
                target_tay_gat1 = (Max_tay_gat1 - 45);
                for(i=0; i<550; i++) { 
                    while(abs(bientrodaytay1Value - target_tay_gat1) > 4) {
                        vTaskDelay(1); 
                        if(!wantExit()) return;
                    }
                }
...
void gap_tay2_duoi(void) 
{
    ...
    do {
        ...
        speed_tay_gat2 = 200;
        target_tay_gat2 = (Max_tay_gat2 - 37);
        ...
        for(i=0; i<550; i++) { 
            while(abs(bientrodaytay2Value - target_tay_gat2) > 7) { vTaskDelay(1); if(!wantExit()) return; }
        }
        ...
        target_chan_sau = 275;
        for(i=0; i<150; i++) {
            while(abs(bientrochantruocValue - target_chan_truoc) > 8) { vTaskDelay(1); if(!wantExit()) return; }
        }
        ...
        for(i=0; i<50; i++) { 
            while(abs(bientrodaytay2Value - (Max_tay_gat2)) > 10) {
                speed_tay_gat2 = 250;
                target_tay_gat2 = (Max_tay_gat2 - 43);
                for(i=0; i<550; i++) { 
                    while(abs(bientrodaytay2Value - target_tay_gat2) > 4) { vTaskDelay(1); if(!wantExit()) return; }
                }
                Ktra_vtri_kep2(); 
                speed_tay_gat2 = 250;
                target_tay_gat2 = (Max_tay_gat2);
...
void gap_tay3_duoi(void)
{
    ...
    do {
        ...
        for(i=0; i<50; i++) { 
            while(abs(bientrodaytay1Value - target_tay_gat1) > 7) { vTaskDelay(1); if(!wantExit()) return; }
        }
        ...
        target_chan_sau = 275;
        for(i=0; i<150; i++) {
            while(abs(bientrochantruocValue - target_chan_truoc) > 10) { vTaskDelay(1); if(!wantExit()) return; }
        }
        ...
        for(i=0; i<250; i++) { 
            while(abs(bientrodaytay1Value - (Min_tay_gat1 + 35)) > 4) {
                speed_tay_gat1 = 250;
                target_tay_gat1 = (Min_tay_gat1 + 100);
                for(i=0; i<150; i++) { 
                    while(abs(bientrodaytay1Value - target_tay_gat1) > 4) { vTaskDelay(1); if(!wantExit()) return; }
                }
                Ktra_vtri_kep3(); 
                speed_tay_gat1 = 50;
                target_tay_gat1 = (Min_tay_gat1 + 35);
...
void Lay_ben_phai_bac_200_duoi (void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
					...
					gap_tay4_duoi_trai_phai(vi_tri_tay_4_phai_duoi);
//					
			...
			// dung tay lan 2
					...
					gap_tay3_duoi_trai_phai(vi_tri_tay_3_phai_duoi);
					da_lay_tay4_duoi = 1;
...
void Lay_ben_trai_bac_200_duoi (void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
					...
					gap_tay4_duoi_trai_phai(vi_tri_tay_4_trai_duoi);
					da_lay_tay1 = 1;
					
					if(CHON_SAN == 0)		{							//SAN DO
							robotRunAngle(1810,10,-900,0.5);
							vTaskDelay(6000); }
					else {
							robotRunAngle(10,10,900,0.8);
							vTaskDelay(6000);
						}
					}
		...
		for(i=0;i<500;i++)
				{
					...
					{	
						if	(CB_kep_3_2 == 0 && CB_ROI_1 == 0 ) 			robotRun(-900,5);	
						else if 	(CB_kep_3_1 == 0 && CB_ROI_4 == 0 ) robotRun(900,5);
		...
		for(i=0;i<500;i++)
				{
					...
					{	
						if	(CB_kep_4_2 == 0 && CB_ROI_1 == 0 ) 					robotRun(-900,5);	
						else if 	(CB_kep_4_1 == 0  && CB_ROI_4 == 0 ) robotRun(900,5);
						vTaskDelay (1);
						if(!wantExit())	break;
					}
				}	
		...
		for(i=0;i<500;i++)
				{
					...
					{	
						if	(CB_kep_1_2 == 0 && CB_ROI_1 == 0  ) 			robotRun(-900,5);	
						else if 	(CB_kep_1_1 == 0 && CB_ROI_4 == 0  ) robotRun(900,5);
		...
		for(i=0;i<500;i++)
				{
					...
					{	
						if	(CB_kep_2_2 == 0 && CB_ROI_1 == 0 ) 			robotRun(-900,5);
						else if 	(CB_kep_2_1 == 0 && CB_ROI_4 == 0  ) robotRun(900,5);
		...
		for(i=0;i<500;i++)
				{
					while(CB_kep_3_2 == 0 || CB_kep_3_1 == 0)	
					{	
						if				(CB_kep_3_2 == 0  ) 		robotRun(1800,5);	
						else if 	(CB_kep_3_1 == 0 ) robotRun(0,5);
		...
		for(i=0;i<500;i++)
				{
					while(CB_kep_4_2 == 0 || CB_kep_4_1 == 0 )	
					{	
						if						(CB_kep_4_2 == 0 ) robotRun(1800,5);	
						else if 	(CB_kep_4_1 == 0   ) robotRun(0,5);
		...
		for(i=0;i<500;i++)
				{
					while(CB_kep_1_2 == 0 || CB_kep_1_1 == 0)	
					{	
						if	(CB_kep_1_2 == 0 ) 			robotRun(1800,5);	
						else if 	(CB_kep_1_1 == 0 ) robotRun(0,5);
		...
		for(i=0;i<500;i++)
				{
					while(CB_kep_2_2 == 0 || CB_kep_2_1 == 0)	
					{	
						if	(CB_kep_2_2 == 0 ) 			robotRun(1800,5);
						else if 	(CB_kep_2_1 == 0 ) robotRun(0,5);
		...
		for(i=0;i<500;i++)
				{
					while(CB_kep_3_2 == 0 || CB_kep_3_1 == 0)	
					{	
						if				(CB_kep_3_2 == 0 ) 		robotRun(0,5);	
						else if 	(CB_kep_3_1 == 0 ) robotRun(1800,5);
		...
		for(i=0;i<500;i++)
				{
					while(CB_kep_4_2 == 0 || CB_kep_4_1 == 0 )	
					{	
						if						(CB_kep_4_2 == 0 ) robotRun(0,5);	
						else if 	(CB_kep_4_1 == 0   ) robotRun(1800,5);
		...
		for(i=0;i<500;i++)
				{
					while(CB_kep_1_2 == 0 || CB_kep_1_1 == 0)	
					{	
						if	(CB_kep_1_2 == 0 ) 			robotRun(0,5);	
						else if  (CB_kep_1_1 == 0 ) robotRun(1800,5);
		...
		for(i=0;i<500;i++)
				{
					while(CB_kep_2_2 == 0 || CB_kep_2_1 == 0)	
					{	
						if	(CB_kep_2_2 == 0 ) 			robotRun(0,5);
						else if 	(CB_kep_2_1 == 0 ) robotRun(1800,5);
