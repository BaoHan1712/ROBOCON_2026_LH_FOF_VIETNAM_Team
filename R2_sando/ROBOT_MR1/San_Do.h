...
void chinh_lai_vi_tri_laser_phai_custom_do(int vitri, int gia_tri_lap, int max_toc);
...
//				
	...
	if (TinHieu_ChuanBi_GapThang == 1) {
			chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_3_lazer_phai_tay_41  , 1000, 65);
	}
	else if (TinHieu_ChuanBi_GapThang == 0) {
			chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_3_lazer_phai_tay_41 - 15 , 1000, 65);
	}
...
//				
	...
	robotStop(0); 
	if (TinHieu_ChuanBi_GapThang == 1) {
			chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_2_lazer_phai_tay_41 , 1000, 65);
	}
	else if (TinHieu_ChuanBi_GapThang == 0) {
			chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_2_lazer_phai_tay_41 - 15 , 1000, 65);
	}
	if (block_pha == 2) {
		SEND_UART (4,1);
			}
...
void Xoay_dau_truoc_cua_do_1(void) {
	...
	if (TinHieu_ChuanBi_GapThang == 1) {
			chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_1_lazer_phai_tay_41 , 1000, 65);
	}
	else if (TinHieu_ChuanBi_GapThang == 0) {
			chinh_lai_vi_tri_laser_phai_custom_do(vi_tri_cua_rung_do_1_lazer_phai_tay_41 - 15 , 1000, 65);
	}
				...
				for(i=0;i<250;i++)
					{
						...
						{	
							Bam_thanh_laser_phai(18,900,-900,vitri - 15,2,-150,10);
							vTaskDelay (1);
							if(!wantExit())	break;
						}
				}
					...
					for(i=0;i<1550;i++)
							{
								...
								{	
									Bam_thanh_laser_phai(8,900,-900,vitri - 15,2,-150,10);
									vTaskDelay (1);
									if(!wantExit())	break;
				...
				for(i=0;i<250;i++)
					{
						while(lazeSauValue > 10)	
						{	
							Bam_thanh_laser_phai(18,900,-900,vitri ,2,-150,10);
							vTaskDelay (1);
							if(!wantExit())	break;
						}
				}
			...
			for(i=0;i<1550;i++)
							{
								...
								{	
									Bam_thanh_laser_phai(8,900,-900,vitri ,2,-150,10);
									vTaskDelay (1);
									if(!wantExit())	break;
			...
			for(i=0;i<250;i++)
					{
						while(lazeSauValue > 10)	
						{	
							Bam_thanh_laser_phai(18,900,-900,vitri - 15,2,-100,10);
							vTaskDelay (1);
							if(!wantExit())	break;
						}
				}				
			for(i=0;i<1550;i++)
						{
							while( CB_vtri_leo == 1 ||CB_Ha_Sau == 1 || CB_Cap_Thanh_Sau == 0)	
							{	
								Bam_thanh_laser_phai(7,900,-900,vitri - 15,2,-150,10);
								if(!wantExit())	break;
								vTaskDelay (1);
							}
						}
...
void Vao_rung_mai_1_do(int vitri)
{
	...
	if (TinHieu_ChuanBi_GapThang == 0) {
					for(i=0;i<250;i++)
					{
						while(lazeSauValue > 10)	
						{	
							Bam_thanh_laser_trai(18,900,-900,vitri + 25,2,150,10);
							vTaskDelay (1);
							if(!wantExit())	break;
						}
				}
...
//       ========================================= */
    ...
    /* =========================================
       ...
       ========================================= */
    action_table[1][4][1] = Leo_bac_400_ko_thanh_do; //da fix
    action_table[1][4][2] = Leo_bac_200_bam_thanh_phai_do;  //da fix
		action_table[1][4][3] = Leo_bac_400_co_thanh_do; //da fix
		action_table[1][4][4] = Xuong_bac_200_do_4;	 //fix gap thang, chua fix ham gap trai
    action_table[1][4][5] = Leo_bac_200_do_5;		//fix di thang, con ben trai ben phai
    action_table[1][4][6] = Leo_bac_200_ko_thanh_do; //fix di thang, con ben trai ben phai
    action_table[1][4][7] = Leo_bac_200_do_7;  //fix di thang,conf ben trai
    action_table[1][4][8] = Leo_bac_200_ko_thanh_do;  //fix di thang, con ben trai ben phai
    action_table[1][4][9]  = Xuong_bac_200_do_9; 	//fix di thang, con ben phai	
