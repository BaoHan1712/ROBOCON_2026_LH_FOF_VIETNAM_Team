...
int	Min_tay_gat2 = 95, Max_tay_gat2 = 800, target_tay_gat2; // max + 6
...
{	
	...
	robotRunAngle(Angle,35,Robot_Angle,0.7);
	...
	robotRunAngle(Angle,28,Robot_Angle,0.8);
...
void gap_tay4(int tracking, int gap) 
{
    ...
    do {
        ...
        Tay2_len;
        speed_tay_gat2 = 250;
//        target_tay_gat2 = Min_tay_gat2 + 97;
...
void gap_tay2(int tracking, int gap) 
{
    ...
    do {
        ...
        speed_tay_gat2 = 250;
//        target_tay_gat2 = Max_tay_gat2 - 84;
				target_tay_gat2 = tracking;
        ...
        speed_tay_gat2 = 200;
//        target_tay_gat2 = (Max_tay_gat2 - 24);
				target_tay_gat2 = gap;
        vTaskDelay(6500); 
        Kep_phai_2_vao;
        vTaskDelay(2000);
...
void gap_tay4_duoi_trai_phai(int vi_tri) 
{
    ...
    do {
        ...
        speed_tay_gat2 = 250;
        target_tay_gat2 = Min_tay_gat2 + 56;
        for(i=0; i<50; i++) { 
            while(CB_xilanh_tay_2 == 1) { vTaskDelay(1); if(!wantExit()) break; }
        }
        for(i=0; i<50; i++) { 
...
void gap_tay1_duoi_trai_phai(int vi_tri) 
{
    ...
    do {
        ...
        speed_tay_gat1 = 250;
        target_tay_gat1 = Max_tay_gat1 - 55;
        for(i=0; i<50; i++) { 
            while(CB_xilanh_tay_1 == 1) { vTaskDelay(1); if(!wantExit()) break; }
        }
        for(i=0; i<50; i++) { 
...
void gap_tay2_duoi_trai_phai(int vi_tri)
{
    ...
    do {
        ...
        Tay2_len;
        speed_tay_gat2 = 250;
        target_tay_gat2 = Max_tay_gat2 - 65;
        for(i=0; i<50; i++) { 
            while(CB_xilanh_tay_2 == 1) { vTaskDelay(1); if(!wantExit()) break; }
        }
        for(i=0; i<50; i++) { 
...
void Lay_ben_trai_bac_200_tren (void) {
		...
		if (da_lay_tay1 == 0 && da_lay_tay2 == 0 && da_lay_tay3 == 0 && da_lay_tay4 == 0) {
			...
			// dung tay lan 3 
					...
					gap_tay2(Max_tay_gat2 - 98, Max_tay_gat2 - 38);
					Nang_cham();
					target_chan_truoc = Min_chan_truoc + 250;
					target_chan_sau = Min_chan_sau + 250;
					if(CHON_SAN == 0) {	 // san do
			...
			// dung tay lan 4
					...
					gap_tay3(Min_tay_gat1 + 98, Min_tay_gat1 + 45);
					Nang_cham();
					target_chan_truoc = Min_chan_truoc + 250;
					target_chan_sau = Min_chan_sau + 250;
