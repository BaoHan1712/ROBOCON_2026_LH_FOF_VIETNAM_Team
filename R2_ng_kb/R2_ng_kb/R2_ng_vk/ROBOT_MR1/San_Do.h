...
void retry_zone_3_o_3_do(int vitri) {
		...
		{	
				while(lazePhaiValue > 330)	
				{	
					Bam_laser_sau(30,0,-900, vitri, 3, 200, 10);
					vTaskDelay(5); 
					if(!wantExit())	break;
				}
		}
