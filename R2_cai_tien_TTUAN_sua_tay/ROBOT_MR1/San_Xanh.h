...
void Vao_rung_mai_1_xanh(int vitri)
{
	...
	target_chan_sau = Min_chan_sau + 250;
		...
		for(i=0;i<250;i++)
		{
			...
			{	
			Bam_thanh_laser_phai_cua_vao(65,-900,900,vitri,2,180,30);
				vTaskDelay (1);
				if(!wantExit())	break;
			}
				}
...
void dat_hop4_2_retry(int do_cao_chan, int goc_tay, int ha_chan, int chontay)
{
